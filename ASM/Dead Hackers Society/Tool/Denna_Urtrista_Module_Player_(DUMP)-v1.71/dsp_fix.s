...
dspmod33_dsp_load_program:
		move.l	a0,dspmod33_dsp_program
		move.l	d0,dspmod33_dsp_length

		;Test for supervisor mode.
		move	sr,d0
		btst	#13,d0
		bne.s	dspmod33_dsp_load
	
		move.l	#dspmod33_dsp_load,-(sp)
		move.w	#$26,-(sp)
		trap	#14
		addq.w	#6,sp

		move.l	dspmod33_dsp_status,d0
		rts

dspmod33_dsp_load:	
		bsr	dspmod33_dsp_reset
		bsr	dspmod33_dsp_go
		move.l	d0,dspmod33_dsp_status
		rts

dspmod33_dsp_reset:	;Power down.
		move.b	#$e,$ffff8800.w
...
dspmod33_dsp_go:
		...
		lea	dspmod33_dsp_bootstrap_code,a0
		move.w	#512-1,d0
dspmod33_next:		btst.b	#1,$ffffa202.w
		beq.s	dspmod33_next
		move.b	(a0)+,$ffffa205.w
		move.b	(a0)+,$ffffa206.w
		move.b	(a0)+,$ffffa207.w
		dbra	d0,dspmod33_next
		rts
...
dspmod33_dsp_program:	ds.l	1
dspmod33_dsp_length:	ds.l	1
dspmod33_dsp_status:	ds.l	1

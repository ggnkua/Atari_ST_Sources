...
fx_23		lea 	green2(pC),a4
		...
		**************
		move.w	#170,cnt_1
fx_24		lea 	green2(pC),a4            	
		bsr	scape
		bsr	BBB
		subq.w	#1,cnt_1
		bne.b	fx_24
		move.w	#50,cnt_1
fx_25		lea 	green2(pC),a4            	
		bsr	scape
		subq.l	#4,light
		bsr	BBB
		subq.w	#1,cnt_1
...
out_1      	rts
;--------------------------------------------------------------                        
scape		lea	pic+256*128,a5
		lea	map+256*128+256,a3
		...
		move.l	#192*4,d4
		move	#150-1,d5
scape_l		move.w	#192-1,d7
draw_sc		move.w	-(a4),d0		
		move.b	(a3,d0.w),d1
		move.b	(a5,d0.w),d0
		and.w	#$ff,d0
		move.w	d1,d3

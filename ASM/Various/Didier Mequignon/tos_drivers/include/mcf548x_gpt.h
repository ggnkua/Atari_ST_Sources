...
#define MCF_GPT_GMS0       (__MBAR+0x000800)
#define MCF_GPT_GCIR0      (__MBAR+0x000804)
#define MCF_GPT_GPWM0      (__MBAR+0x000808)
#define MCF_GPT_GSR0       (__MBAR+0x00080C)
#define MCF_GPT_GMS1       (__MBAR+0x000810)
#define MCF_GPT_GCIR1      (__MBAR+0x000814)
#define MCF_GPT_GPWM1      (__MBAR+0x000818)
#define MCF_GPT_GSR1       (__MBAR+0x00081C)
#define MCF_GPT_GMS2       (__MBAR+0x000820)
#define MCF_GPT_GCIR2      (__MBAR+0x000824)
#define MCF_GPT_GPWM2      (__MBAR+0x000828)
#define MCF_GPT_GSR2       (__MBAR+0x00082C)
#define MCF_GPT_GMS3       (__MBAR+0x000830)
#define MCF_GPT_GCIR3      (__MBAR+0x000834)
#define MCF_GPT_GPWM3      (__MBAR+0x000838)
#define MCF_GPT_GSR3       (__MBAR+0x00083C)
#define MCF_GPT_GMS(x)     (__MBAR+0x000800+((x)*0x010))
#define MCF_GPT_GCIR(x)    (__MBAR+0x000804+((x)*0x010))
#define MCF_GPT_GPWM(x)    (__MBAR+0x000808+((x)*0x010))
#define MCF_GPT_GSR(x)     (__MBAR+0x00080C+((x)*0x010))

...
{//mode  class  model bits sstart  pelm  dac
 {0x0D, GRAPH, PLANAR4, 4, 0xA0000, 0xFF, 0x01},
 {0x0E, GRAPH, PLANAR4, 4, 0xA0000, 0xFF, 0x01},
 {0x0F, GRAPH, PLANAR1, 1, 0xA0000, 0xFF, 0x00},
 {0x10, GRAPH, PLANAR4, 4, 0xA0000, 0xFF, 0x02},
 {0x11, GRAPH, PLANAR1, 1, 0xA0000, 0xFF, 0x02},
 {0x12, GRAPH, PLANAR4, 4, 0xA0000, 0xFF, 0x02},
 {0x13, GRAPH, LINEAR8, 8, 0xA0000, 0xFF, 0x03},
};

/* convert index in vga_modes[] to index in video_param_table[] */
static u8 line_to_vpti[MODE_MAX+1]={
...
static u8 dac_regs[DAC_MAX_MODEL+1]=
{0x3f,0x3f,0x3f,0xff};

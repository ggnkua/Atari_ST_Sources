 ...
 */
#define xSemaphoreAltTake( xSemaphore, xBlockTime )		xQueueAltReceive( ( xQueueHandle ) xSemaphore, NULL, xBlockTime )
 ...
 * sacrifices execution speed to ensure better interrupt responsiveness.
 */
#define xSemaphoreAltGive( xSemaphore )		xQueueAltSend( ( xQueueHandle ) xSemaphore, NULL, semGIVE_BLOCK_TIME)

;----------------------------------------
; Shadow Sorceror Quartet Demo by MUG U.K
;----------------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\shadsorc.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\shadsorc.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\shadsorc.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	" +------------------------------------+",$d,$a
	dc.b	" | MUG U.K¿ presents: Shadow Sorceror |",$d,$a
	dc.b	" +------------------------------------+",$d,$a,$a
	dc.b	"This is another walk-over to rip as the",$d,$a
	dc.b	"data was stored as uncompressed files ",$d,$a
	dc.b	"on the disk.  The hardest part was to ",$d,$a
	dc.b	"rip out the graphics !!",$d,$a,$a
	dc.b	"        Quartet Music by ??????",$d,$a

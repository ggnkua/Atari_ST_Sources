;-------------------------------
; Tusker Quartet Demo by MUG U.K
;-------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s incbin	f:\quartet\hacked\tusker.4v	 ; Song Data
	even
voice_s incbin	f:\quartet\hacked\tusker.set ; Voice Set
	even
picture incbin	f:\quartet\hacked\piccies\tusker.pi1 ; Degas 
	even
;---------------------------------------------------
...
main	cmpi.b	#$39,$fffc02 ; wait for space bar
	bne	main	; not space bar - redo loop
...
text	dc.b	27,"E"
	dc.b	"     +----------------------------+    ",$d,$a
	dc.b	"     | MUG U.K¿ presents - Tusker |    ",$d,$a
	dc.b	"     +----------------------------+    ",$d,$a,$a
	dc.b	"As per usual, I used the cartridge, but",$d,$a
	dc.b	"I rarely use the built-in music ripper ",$d,$a
	dc.b	"because it isn't that good ! Chip music",$d,$a
	dc.b	"hacked from 'Year After Demo' !!",$d,$a,$a

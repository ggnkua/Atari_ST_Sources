;--------------------------------------------
; Shadow Of The Beast Quartet Demo by MUG U.K
;--------------------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\beast.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\beast.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\beast.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"+---------------------------------------+",$d,$a
	dc.b	"|MUG U.K¿ presents: Shadow Of The Beast |",$d,$a
	dc.b	"+---------------------------------------+",$d,$a,$a
	dc.b	"This was a job for the Ultimate Ripper,",$d,$a
	dc.b	"but at least it's done now !!  The chip",$d,$a
	dc.b	"music is from Shadow Of The Beast II !!",$d,$a,$a
	dc.b	"     Quartet Music by Eldritch The Cat",$d,$a
	dc.b	"       Chip Music by Sound Images",$d,$a

;--------------------------------
; Gazza 2 Quartet Demo by MUG U.K
;--------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\gazza2.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\gazza2.set ; Voice Set
	even
...
text	dc.b	27,"E"
	dc.b 	"    +-----------------------------+",$d,$a
	dc.b	"    | MUG U.K¿ presents: Gazza II |",$d,$a
	dc.b	"    +-----------------------------+",$d,$a,$a

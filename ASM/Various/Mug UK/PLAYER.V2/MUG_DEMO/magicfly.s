;----------------------------------
; Magic Fly Quartet Demo by MUG U.K
;----------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\magicfly.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\magicfly.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\magicfly.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"    +------------------------------+",$d,$a
	dc.b	"    | MUG U.K¿ presents: Magic Fly |",$d,$a
	dc.b	"    +------------------------------+",$d,$a,$a
	dc.b	"This was really easy because it was",$d,$a
	dc.b	"stored as two files on the disk !!!",$d,$a,$a

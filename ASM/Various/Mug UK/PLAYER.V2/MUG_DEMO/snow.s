;-----------------------------------
; Snowstrike Quartet Demo by MUG U.K
;-----------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s incbin	f:\quartet\hacked\snowstrk.4v	 ; Song Data
	even
voice_s incbin	f:\quartet\hacked\snowstrk.set ; Voice Set
	even
picture incbin	f:\quartet\hacked\piccies\snowstrk.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b	"    +--------------------------------+",$d,$a
	dc.b	"    | MUG U.K¿ presents - Snowstrike |",$d,$a
	dc.b	"    +--------------------------------+",$d,$a,$a

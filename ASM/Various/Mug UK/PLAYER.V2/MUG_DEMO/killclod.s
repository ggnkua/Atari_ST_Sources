;--------------------------------------
; Killing Cloud Quartet Demo by MUG U.K
;--------------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\killing.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\killing.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\killing.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"  +----------------------------------+",$d,$a
	dc.b	"  | MUG U.K¿ presents: Killing Cloud |",$d,$a
	dc.b	"  +----------------------------------+",$d,$a,$a

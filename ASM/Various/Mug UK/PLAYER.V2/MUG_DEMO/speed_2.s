;--------------------------------------
; Metal Masters Quartet Demo by MUG U.K
;--------------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\speed_2.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\speed_2.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\speed_2.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"  +---------------------------------+",$d,$a
	dc.b	"  | MUG U.K¿ presents: Speedball II |",$d,$a
	dc.b	"  +---------------------------------+",$d,$a,$a
	dc.b	"This music hack was made slighly easier",$d,$a
	dc.b	"due to me being really lazy and using",$d,$a
	dc.b	"the Ultimate Ripper !! So what if I'm ",$d,$a
	dc.b	"lazy, at least I admit it !!",$d,$a,$a
	dc.b	"      Chip Music by Jochen Hippel",$d,$a

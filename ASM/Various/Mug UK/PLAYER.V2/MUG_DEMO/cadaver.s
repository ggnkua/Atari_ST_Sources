;--------------------------------
; Cadaver Quartet Demo by MUG U.K
;--------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\cadaver.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\cadaver.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\cadaver.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"     +----------------------------+",$d,$a
	dc.b	"     | MUG U.K¿ presents: Cadaver |",$d,$a
	dc.b	"     +----------------------------+",$d,$a,$a
	dc.b	"This was a job for the Ultimate Ripper,",$d,$a
	dc.b	"but at least it's done now !!",$d,$a,$a

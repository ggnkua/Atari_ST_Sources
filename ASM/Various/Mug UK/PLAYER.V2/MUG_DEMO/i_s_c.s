;-------------------------------------------------------
; International Soccer Challenge Quartet Demo by MUG U.K
;-------------------------------------------------------
...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\i_s_c.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\i_s_c.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\i_s_c.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"     +----------------------------+",$d,$a
	dc.b	"     | MUG U.K¿ presents: 'I.S.C' |",$d,$a
	dc.b	"     +----------------------------+",$d,$a,$a
	dc.b	"This is getting too easy to rip this",$d,$a
	dc.b	"Quartet stuff, especially when you",$d,$a
	dc.b	"are using the Ultimate Ripper !!",$d,$a,$a

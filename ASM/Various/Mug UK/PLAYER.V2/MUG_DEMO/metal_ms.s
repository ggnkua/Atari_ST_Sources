...
sing_s	incbin	rob5.bin		; Quarter Player Routine
	even
song1_s	incbin	f:\quartet\hacked\metal_ms.4v	 ; Song Data
	even
voice_s	incbin	f:\quartet\hacked\metal_ms.set ; Voice Set
	even
picture	incbin	f:\quartet\hacked\piccies\metal_ms.pi1 ; Degas 
	even
;---------------------------------------------------
...
text	dc.b	27,"E"
	dc.b 	"  +----------------------------------+",$d,$a
	dc.b	"  | MUG U.K¿ presents: Metal Masters |",$d,$a
	dc.b	"  +----------------------------------+",$d,$a,$a
	dc.b	"There was no need to hack this music",$d,$a
	dc.b	"because it was stored as files on the",$d,$a
	dc.b	"disk - makes life easier !!",$d,$a,$a

...
* Permet l'utilisation des G_BOUNDING/G_BOUNDED
	cmp.w		#$400,global
	blt		.no_gbound

	appl_getinfo	#AES_GBOUND
	tst		int_out
	beq		.no_gbound
...
* Verification des bits de ob_flags/ob_states
	trouve_objc	d3,d5				; et on verifie qu'il est bien "selectable"
...
*~~~ debut de gestion des boutons RADIO ~~~*
	moveq.l			#1,d2		; flag : precedent = bouton clique ? (1 = oui, 0 = non)
.lp_deselect
	trouve_bouton_precedent	d5,d3
	cmp.w			#-1,d0
	beq			.ok_deselectionne
	cmp.w			d0,d5
	beq			.yo
	moveq.l			#0,d2
.yo	xobjc_change		d3,d0
	bra			.lp_deselect
.ok_deselectionne
...
* X , 2(a6)->Y , 4(a6)->X2 , 6(a6)->Y2 , 8(a6)->W , 10(a6)->H
wd_redraw_form

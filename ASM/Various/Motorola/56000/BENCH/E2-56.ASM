...
;File name: E2-56.asm
;**************************************************************************
;    Maximum sample rate: 1.317 ms at 20.5 MHZ/ 999.6 us at 27.0 MHz
;    Memory Size: Prog:  118 words ; Data:  2050 words
;    Number of clock cycles: 26990  (13495 instruction cycles)
...
;
;    call fft macro
     fftedn1 256,$40,$240,$342,$340,$341 

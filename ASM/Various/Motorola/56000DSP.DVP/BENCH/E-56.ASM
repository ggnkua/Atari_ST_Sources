...
;File name: E-56.asm
;**************************************************************************
;	Maximum sample rate:  458.2 us at 20.5 MHZ/ 347.9328.9 us at 27.0 MHz
;	Memory Size: Prog:  254 words ; Data:  1794 words
;	Number of clock cycles:	9394 (4697 instruction cycles)
...
;
;	call fft macro
     fftreald 256,$40,$240,$342,$340,$341 
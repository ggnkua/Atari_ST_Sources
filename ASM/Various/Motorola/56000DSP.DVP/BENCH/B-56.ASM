...
;File name: B-56.asm
;**************************************************************************
;	Maximum sample rate:  645.1 us at 20.5 MHZ/ 489.8 us at 27.0 MHz
;	Memory Size: Prog:  105 words ; Data:  1536 words
;	Number of clock cycles:	13225 (6612 instruction cycles)
...
; complex 256 point FFT using the

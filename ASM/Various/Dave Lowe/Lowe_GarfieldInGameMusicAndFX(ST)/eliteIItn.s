...
pbaba1
	...
	dc.w	a01,cr,d02,cr,bb00hcr,eb02,cr
	dc.w	g01,cr,c02,Cr,ab01,cr,db02,cr
	...
	dc.w	a01,cr,d02,cr,bb01,cr,eb02,cr
	dc.w	g01,cr,c02,cr,ab01,cr,db02,cr
	dc.w	a01,cr.FAP@b01,cr,eb02,cr
...
pverse_bass2
	...
	dc.w	a02,cr*2,a03-f"j"
$3~'I7er1-b"j3<`d3-b"j"$3~'`abh7v/&y!0f="#*"
L0gz7w56!(wr~#(p$#(wrw
	!7jrL$!2|"&+2l$a2|"&*"
[a7jvvu#0|"&+3l$a2|"&*"[a7jsL$!2|"&+3l$a2|"&*"
[a7jsL&a0|"&*"[a7j3q1?tu5  
7q1nut_2p "
 qa7j31us[5*"
 qa3*9t:r28}9`  
 qa7j31uv[3* 
 qa3*9t:r28}<4  [a7j2d&a2|"&*"[a7j3q1?tu5  7q1n` [a7j"1d&a2|"&+3l&a2|"&+3l&a2|"&+3l&a2|"&*"[a7j"0d&a2|"&+3,$a2|"'* [a7j3q1?tu5  7q1n "
[a7j"1d$a2|"&+3l$a2|"&+3l$a2|"&+3l$a2|"&*"[a7j"1d&!2|"&+2x$&!2|"'* [a@™Ñ‘½Ö}=( °·7Bª******************************
proj1
	lea engine1_vars,a0
	tst.w (a0)
	beq tt2
...
wind_env1:	dc.w 0,0,2,3,4,5,6,7,8,10,12,15,17,20,21,22,24,25,26,29,32,34,37,38,40,42,43,44,44,40,40,38
		dc.w 40,45,255
wind_env2:	dc.w 0,44,42,40,48,46,44,43,40,45,43,40,37,36,35,33,30,25,28,26,25
		dc.w 20,18,15,12,255
wind_env3:	dc.w 0,12,255

wind_env4:	dc.w 0,40,255

wind_env5:	dc.w 0,15,15,15,14,14,14,13,12,11,10,9,8,7
		dc.w 7,7,7,7,6,6,6,6,5,5,5,5,4,4,4,4,3,2,1,0,255
...
ship_to_ship_fx
	dc.w pboff
  	...
  	dc.w new_snd
  	dc.l sinep
	dc.w	c03,4,e03,4,b02,4,a02,4
	dc.w	e03,4,g03,4,f02,4,bb02,4
	dc.w	gb03,4,b02,4,c02,4,db03,4
	dc.w	a03,4,gb03,4,b02,4,ab02,4
  	dc.w end_fxp
...
fxjump_table:  
	...
	;---------------------------
				;    looping fx 14 to 17
	dc.l	windfx		;(14) run with wind2 for two channels(37)
	dc.l	space_station_backfx	;(15)
	dc.l	factroarfx	;(16)
	dc.l	fuelscoopfx	;(17)
	;----------------------------
...
max_fx	dc.l	39		;number + 1 for testing only
;______________________________________________________________________

/* Indice du ressource pour FASHION2 */
...
#define PREF_T1_COPY 15  /* TEXT dans l'arbre PREF */
#define PREF_T2_COPY 16  /* TEXT dans l'arbre PREF */
#define PREF_GRIDX 26  /* FBOXTEXT dans l'arbre PREF */
#define PREF_GRIDY 29  /* FBOXTEXT dans l'arbre PREF */

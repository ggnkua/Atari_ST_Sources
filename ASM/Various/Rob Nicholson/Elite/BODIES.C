/* Crude program to grab bodies bit maps */

#include <stdio.h>

#define inp_file    "bodies.pc1"
#define out_file    "bodies.bit"
...

{
    ...
    printf("BODIES V1.0 (c) 1988 Mr. Micro Ltd.\n\n");
    ...
    fclose(inp_fp);
    puts("Done.");
    make("b_human1", 0, 4, 72);
    make("b_lizard", 4*8, 4, 72);
    make("b_lobster", 8*8, 4, 72);
    make("b_rodent", 12*8, 4, 72);
    make("b_frog", 16*8, 4, 72);
    make("b_bird", 160*80, 4, 72);
    make("b_human2", 160*80+4*8, 4, 72);
    make("b_feline", 160*80+8*8, 4, 72);
    make("b_human3", 160*80+12*8, 4, 72);
    make("b_insect", 160*80+16*8, 4, 72);
    fclose(out_fp);
}

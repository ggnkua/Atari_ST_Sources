/* Crude program to grab aliens bit maps */

#include <stdio.h>

#define inp_file    "aliens.pc1"
#define out_file    "aliens.bit"
...

{
    ...
    printf("ALIENS V1.0 (c) 1988 Mr. Micro Ltd.\n\n");
    ...
    puts("Done.");
    make("alien1", 0, 4, 38);
    make("alien2", 4*8, 4, 38);
    make("alien3", 8*8, 4, 38);
    make("alien4", 12*8, 4, 38);
    fclose(out_fp);
}

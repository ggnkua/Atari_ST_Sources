...
GT2_FORMAT_NUMBER:	Equ	4	; Dernier num‚ro format GT2 support‚ par la routine
...
;	bge.s	.copychk		; Si version ò 3, il DOIT y avoir un chunk de fin
				; Mais non en fait … cause d'un bug, autant pour moi...
...
.finmod:
	...
	bge.s	.endchunk
	move.b	#3,3(a4)		; On fait comme si c'‚tait la version num‚ro 3
...
gtkpl_new_module:
	...
	movem.l	d1-a5,-(sp)
	move.l	f109.adrmod(sp),a0	; ððð> a0 = adresse du module
...
; -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
; Trouve le chunk des volume des pistes et fixe les volumes
; Volumes … $1000 par d‚faut
	move.w	d7,d1
	subq.w	#1,d1		; d1 = compteur de pistes
.tvolloop3:
	move.w	#$1000,-(sp)
	move.w	d1,-(sp)
	bsr	gtkpl_set_track_volume
	addq.l	#4,sp
	dbra	d1,.tvolloop3

; Recherche du chunk
	move.l	a0,a4
.tvolloop:	cmp.l	#'ENDC',(a4)
	beq.s	.tvolend		; Fin du module atteinte, volumes non trouv‚s
	cmp.l	#'TVOL',(a4)
	beq.s	.tvolfound
	add.l	4(a4),a4		; Chunk suivant
	bra.s	.insloop
...
.tvolfound:
	addq.l	#8,a4
	move.w	(a4)+,d1		; Nombre de piste dont on a le volume
	beq.s	.tvolend		; Y en a pas ?
	cmp.w	d7,d1		; Y en a trop ?
	ble.s	.tvolok
	move.w	d7,d1		; Oui, on se limite aux piste des patterns
.tvolok:	subq.w	#1,d1		; d1 = compteur de pistes
	moveq	#0,d2		; d2 = num‚ro de voie
.tvolloop2:
	move.w	(a4)+,-(sp)
	move.w	d2,-(sp)
	bsr	gtkpl_set_track_volume
...
*÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷*
*	Fixe le volume de mixage d'une voie.			*
*	ParamŠtres:					*
*	- W voie: la voie dont on veut changer le volume.		*
*	- W volume: volume de la piste (0..$1000..$FFFF).		*
*÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷*
gtkpl_set_track_volume:
	CArgs	#52+4,f113.voie.w,f113.volume.w

	movem.l	d1-a5,-(sp)

	lea	gtkpl_num_track,a0
	move.w	f113.voie(sp),d1
	move.w	(a0,d1.w*2),d1	; d1 = piste
	mulu.w	#next_t,d1
	lea	([gtkpl_adr_info_track],d1.l),a3
	move.w	f113.volume(sp),d4
...
.newline:	move.w	mod_songpos(a0),mod_cursongpos(a0)	; Actualise la position
	...
	clr.w	mod_flagnewpos(a0)	; Indique que la position et la ligne restent les mˆmes
...
gtkpl_pas_tone_p:
	...
	move.w	ftune_s(a4),volsam_t(a3)	; Recopie le finetune du sample
...
.ok:	lsr.w	#8,d4		; De 0 … $FF
	...
	lea	gtkpl_vlin_2_exp_trk(pc),a4
	add.w	(a4,d4.w),d5
...
fx_do_set_trk_exp_vol:
	...
	lea	gtkpl_vexp_2_lin_trk(pc),a4
...
gtkpl_vexp_2_lin_trk:	IncBin	'v_e2l_t.bin'	; exp -> lin, pour le mix des pistes
gtkpl_vlin_2_exp_trk:	IncBin	'v_l2e_t.bin'	; lin -> exp, pour le mix des pistes
...
gtkpl_gt2_chunknames:	Dc.l	'XCOM','TCN1','SONG','PATS'
		...
		Dc.l	'TVOL'
		Dc.l	0
	; Cette liste est valable jusqu'… la version 4 du format GT2. Pour
...
mix_volume_t:	Rs.w	1	; Volume lin‚aire normal d'une piste: $1000
mix_volume_e_t:	Rs.w	1	; Volume exponentiel normal d'une piste: $C00

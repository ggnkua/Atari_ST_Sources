...
PLAYDSP:	Ident	$0,$8370	; Graoumf Tracker - by Laurent de SORAS (Dumbo/BiG NoZ) 94-96
...
resampling030:
	...
	rep	b		; *** Ne peut pas ˆtre interrompu
	asl	a
_no_amp:	move	a,x0		; x0 devient le multiplicateur -> 24 bits

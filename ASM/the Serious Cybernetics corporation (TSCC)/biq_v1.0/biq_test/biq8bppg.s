*******************************************************************************
*             68000 BiQ decoder, 8bpp grayscale, version 1.0                  *
*******************************************************************************
...
*******************************************************************************
*  void d_BiQ_8bGray(a0.l * BiQSrc, a1.l * Dst, a2.l * TmpBuffer)
*
* Decode a given BiQ image (type 0x00, 8bpp grayscale). a2.l must point to a
* workbuffer, which has the same size dimensions as the destination image.
*
* Note: This code is by no means optimized for speed!! trashes d0-a6.
*******************************************************************************

		section	text
d_BiQ_8bGray:	cmpi.l	#'_BiQ',(a0)+	; Check ID header
		bne.s	.return

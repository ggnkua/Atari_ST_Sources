/*--------------------------------------------------------------------------*/
/*  File name:  PORTAB.H                        Revision date:  1999.12.03  */
/*  Revised by: Ulf Ronald Andersson            Revision start: 1999.11.26  */
/*  Created by: Various authors                 Creation date:  Undefined   */
/*--------------------------------------------------------------------------*/
/*  Purpose:    Defines macros and types etc, to force various compilers to */
/*              behave in a more standardized way, so sources can work with */
/*              all of them when this header file is included.              */
/*--------------------------------------------------------------------------*/
/*  Comment:    The material in this file is taken from various older such  */
/*              header files.  The information itself is obviously in the   */
/*              Public Domain, and I hereby formally declare this file PD.  */
/*              It was released for the project STinG, but may be used for  */
/*              any other purpose without affecting any copyrights.         */
/*--------------------------------------------------------------------------*/
...
#define TURBO_C    1                          /* Turbo C or Pure C Compiler  */
...
#define GEM        XGEM                       /* FlexOS default is X/GEM     */
    ...
    /* NB: The GEM patches seem doubtful, thus disabled in the line below */
#undef GEM
/*****************************************************************************/

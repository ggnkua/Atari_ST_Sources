...
key:	cmpi.b	#$39+$80,$fffffc02.w	; Wait for space bar to be pressed.
	bne.s	key
...
player:	move.w	(a3),d6
	...
	add.w	(a5),d6
	add.w	(a6),d6
	movem.l	sound_look(pc,d6.w),d6-d7
	movem.l d6-d7,$ffff8800.w
ch4add:	adda.w	2(a2),a6
ch3add:	adda.w	2(a2),a5
ch2add:	adda.w	2(a2),a4
	adda.w	(a2)+,a3
	rte
sound_look:
	incbin	2chanmov.tab
...
tune:	incbin FOIL.sng
	even
slist:	incbin FOIL.eit
	even

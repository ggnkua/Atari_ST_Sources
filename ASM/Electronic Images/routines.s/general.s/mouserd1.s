...
start_mouse	MOVE #5,msepackage
		MOVE.L #mousex-1,mouse_ptr
		MOVE (SP)+,D0
		BCLR #6,$FFFFFA11.W
		RTE

mouse_read	SUBQ #1,msepackage
		BMI.S mouse_done
		MOVE.L A0,-(SP)
		MOVE.L mouse_ptr(PC),A0
		ADDQ.L #1,mouse_ptr
...
* The vbl sends command to the ikbd
* to make it report the mouse xy.

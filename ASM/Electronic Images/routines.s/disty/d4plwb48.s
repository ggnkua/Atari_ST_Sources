; 64*48 4 plane Disting scroller WORD BENDING TOO!!!
; (C) Martin Griffiths Sept 1990.
; This takes about 30% cpu time.
...
a1		MOVEM.W (A6)+,D2-d5
		...
		ROL.L #1,D4
		ROL.L #1,D5
		MOVEM.W D2-D5,bufsize(A3)
		MOVEM.W D2-D5,bufsize-208(A3)
		ROL.L #1,D2
		ROL.L #1,D3
		ROL.L #1,D4
		ROL.L #1,D5

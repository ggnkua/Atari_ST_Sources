; 64*48 4 plane Disting scroller BYTE BENDING TOO!!!
; (C) Martin Griffiths Sept 1990. This takes about 60% cpu time.
...
Start		MOVE #$2700,SR
		...
		MOVE.L #$00760065,$FFFF8240+4.W
		MOVE.L #$00540043,$FFFF8240+8.W
		MOVE.L #$00320021,$FFFF8240+12.W
		MOVE.L #$00010012,$FFFF8240+16.W
		MOVE.L #$00230034,$FFFF8240+20.W
		MOVE.L #$00450056,$FFFF8240+24.W
		MOVE.L #$00670444,$FFFF8240+28.W
		MOVE #$2300,SR
...
; Shift hdist upwards and place next dist value in table.
...
notwang		MOVE D1,dister
		...
		ADD D0,D0
		ADD D0,D0			x4
		MOVE.W D0,dist_tab+94		place in table
		...
		add.l #bufsize*4,A3		skip 2 buffers(2 pix step)	
		ADDQ #4,D6			add 2(2 pixel step)
		CMP #8,D6
		BNE t2
...
notwrap		MOVE D6,(A1)			otherwise restore
		...
		cmp #384*3,d0			are we in 2nd chunk
		Bne.S norm 			already?
...
char_tab	rept 33
		dc.l bigfontspce
		endr
		dc.l bigfont+(30*1536)		; !
		dc.l bigfontspce 		; "
		dc.l bigfontspce 		; #
		dc.l bigfontspce 		; $
		dc.l bigfontspce 		; %
		dc.l bigfontspce 		; &
		dc.l bigfont+(29*1536)		; '
		dc.l bigfont+(32*1536)		; (
		dc.l bigfont+(33*1536)		; )
		dc.l bigfontspce 		; *
		dc.l bigfontspce 		; +
		dc.l bigfont+(28*1536)		; ,
		dc.l bigfont+(26*1536)		; -
		dc.l bigfont+(27*1536)		; .
		dc.l bigfontspce 		; /
		dc.l bigfontspce 		; 0
		dc.l bigfontspce 		; 1
		dc.l bigfontspce 		; 2

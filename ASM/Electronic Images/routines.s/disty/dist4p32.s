; 32*32 4 plane Disting scroller (C) Martin Griffiths Sept 1990.
; This takes about 16-18% cpu time(ish....)
...
notwang		MOVE D1,dister
		...
		LEA bufsize*2(A3),A3		skip 2 buffers(2 pix step)	
...
i		SET 0
		...
		MOVEM.W D2-D5,i-8(A3)
		ROL.L #1,D2
		ROL.L #1,D3
		ROL.L #1,D4
		ROL.L #1,D5
		MOVEM.W D2-D5,i+200+bufsize(A3)
		MOVEM.W D2-D5,i-8+bufsize(A3)
		ADDQ.L #8,A5
		ADDQ.L #8,A6
i		SET i+linewid
		ENDR
...
j		SET 0
		...
		LEA j(A0),A1
		ADD.L (A4,D0),A1
		MOVEM.L (A1)+,D0-D7/A5-A6
		MOVEM.L D0-D7/A5-A6,i(A2)
		MOVEM.L (A1)+,D0-D7/A5-A6
		MOVEM.L D0-D7/A5-A6,i+40(A2)
		MOVEM.L (A1)+,D0-D7/A5-A6
		MOVEM.L D0-D7/A5-A6,i+80(A2)
		MOVEM.L (A1)+,D0-D7/A5-A6
		MOVEM.L D0-D7/A5-A6,i+120(A2)
i		SET i+160
j		SET j+linewid
		ENDR
		move #$000,$ffff8240.w

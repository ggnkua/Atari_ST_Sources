...
Draw_Sprites	LEA xymodbuf(PC),A3
		MOVEM.L $78+$28(A3),D0-D7/A0-A2
		MOVEM.L D0-D7/A0-A2,$7C+$28(A3)
...
draw		LEA sprite1(PC),A0
		...
		ADD.W D1,D1		; y*2
		LEA xinfo_tab(PC),A2
		MOVEM.L (A2,D0),D5/D6/D7
		LEA mul160_look(PC),A2	; *160 table
		ADD.W (A2,D1),D5	; add line offset to row offy
		MOVE D5,(A6)+		; save offset(for delete)
		ADDA D5,A1		; screen addr
...
.lessthan8	SWAP D5
		MOVE #32-1,D5
.lpl8		SWAP D5
		MOVEM.L (A0)+,D0-D4	; mask 'n' 4 planes data
		ROR.L D5,D0 
		ROR.L D5,D1 
...
.lpm8		SWAP D5
		...
		ROL.L D5,D0 
		ROL.L D5,D1 
		ROL.L D5,D2 		; shift the 32 pixels
		ROL.L D5,D3 
		ROL.L D5,D4
		AND.W D0,(A1)
 		OR.W D1,(A1)+
...
xinfo_tab	REPT 20
		...
		DC.L 0
		DC.W 3,i
		DC.W %1110000000000000,%1110000000000000
		...
		DC.L 0
		DC.W 7,i
		DC.W %1111111000000000,%1111111000000000
		...
		DC.L 0
		DC.W 9,i
		DC.W %1111111110000000,%1111111110000000

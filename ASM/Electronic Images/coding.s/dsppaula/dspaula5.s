...
Start_music	MOVE.W #1,-(A7)	; ability
...
.wait2		BTST.B #1,$FFFFA202.W
		BEQ.S .wait2
		MOVE.L #0,$FFFFA204.W		; strobe dsp to continue
		move.b  #1,$FFFF8935.w  ;49.2khz
                move.b  #2,$FFFF8937.w	;CODEC <- Multiplexor
                move.b  #3,$FFFF8938.w	;L+R <- Soundchip(NOT ADC!)
                move.w  #%1000000110011001,$FFFF8930.w	; dma output 25mhz clock,no handshake
                move.w  #%1011100100011101,$FFFF8932.w	; dsp out -> dac
...
.wait1		BTST #1,-5(A6)			;; sync 
		...
		BEQ.S .zero
		MOVE.L #((3546895*(1<<9))/freq)*(1<<14),D1
		DIVU.L D0,D1
...
Module		INCBIN "e:\mods\bestsid.mod"

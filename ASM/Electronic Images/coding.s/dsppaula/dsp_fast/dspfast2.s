...
.wait2		BTST.B #1,$FFFFA202.W
		...
		MOVE.L #freq,$FFFFA204.W	; send dsp frequency to play at.
                MOVE #%0000100110010000,$FFFF8930.w	; dma output 25mhz clock,no handshake
                MOVE #%1011110110011100,$FFFF8932.w	; dsp out -> dac, dsp in <- dma out
		BCLR #7,$FFFF8901.w  		; select playback register
                MOVE #64+256+512,$FFFF8920.w 	; 8bit stereo,play 4 track,dac to track 1
...
music_int1	MOVE.W #$2500,SR
		MOVEM.L	A0-A6/D0-D7,-(A7)
		MOVE.L #music_int2,$134.W
		NOT.L $FFFF9800.W
		LEA $ffffa200.w,A6		
		LEA 7(A6),A4
		LEA 4(A6),A5
...
music_int2	MOVE.W #$2500,SR
		MOVEM.L	A0-A6/D0-D7,-(A7)
		MOVE.L #music_int3,$134.W
		NOT.L $FFFF9800.W
		LEA $ffffa200.w,A6		
		LEA 7(A6),A4
		LEA 4(A6),A5
...
send_voice	CLR.W $FFFF8900.W		; DMA OFF
		MOVEQ #0,D0
...
framestart	DC.L dummy

; Set DMA to buffer, D0 = start / D1 = end.

Set_DMA		MOVE.L framestart(PC),D0
		AND.L #$FFFFFFF0,D0
		MOVE.L D0,D1
		ADD.L #1200,D1
		...
		MOVE #1,$FFFF8900.W		; DMA ON,timer a int
		RTS

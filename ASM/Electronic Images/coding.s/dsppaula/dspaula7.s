...
mt_SetDMA
	...
	LEA	mt_chan1temp(PC),A6
	MOVE.W	no_channels+2(PC),D7
.lp	MOVE.L 	n_loopstart(A6),sam_lpstart(A5)
...
dummy		
old_stuff	DS.L 10
Module		;INCBIN d:\mods\guitarsl.mod
		INCBIN d:\mods\8mods\cd2part2.mod
		even

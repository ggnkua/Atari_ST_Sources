...
.wait2		BTST #0,$FFFFA202.W		;; sync 
		BEQ.S .wait2			;; 
		MOVE.L (A6),D4			; get last times
.wait3		BTST #0,$FFFFA202.W		;; sync 
		BEQ.S .wait3			;; 
...
.nosetnewstart	MOVE.L sam_lpstart(A1),D2
		Beq.S .nosetnewloop
		MOVEQ #0,D1
...
.nosetnewloop	SUBQ.W #extra_samps,D5
		MOVE.W D5,last_time(A1)
...
do_vce		TST.B D3		; sample looping?
		BEQ.S not_inloop
		TST.B D2		; sample got a loop?
		BEQ.S vce_isoffcont
		ADD.L D4,A0		; yup..
		BRA.S vclp_cont

not_inloop	ADD.L D4,A0
		BRA.S vc_cont

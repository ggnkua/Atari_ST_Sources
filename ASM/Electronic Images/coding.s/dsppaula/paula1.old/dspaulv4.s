...
music_int	MOVE.W #$2500,SR
		...
		MOVEQ #0,D7
		MOVE.l D7,$FFFFA204.W	; strobe -> signal dsp to go!
		LEA ch1s(PC),A1
		MOVEQ #0,D6
		BSR.S send_voice
		LEA ch2s(PC),A1
...
.wait1		BTST #1,$FFFFA202.W		;; sync 
		...
		move.l #$7fffff,d1		; 
.zero		
.wait2		BTST #1,$FFFFA202.W		;; sync 
		BEQ.S .wait2			;; 
		MOVE.L D1,(a6)			; send freq
...
vc_loop_lp	
		MOVE.B (A0)+,(A6)
		waitn	
vc_lp_cont	CMP.L A3,A0
		BLT.s vc_loop_lp
vc_lp_resetlp	MOVE.L A5,A0
		BRA.S vc_loop_lp
vce_done	MOVE.B (A6),D0
...
Module		INCBIN "d:\mods\ENIGMA.mod"

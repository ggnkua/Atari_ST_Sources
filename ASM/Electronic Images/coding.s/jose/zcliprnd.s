...
nozedp2:
                ...
                sub.w   D5,D6           ; Zmax-Z2
                move.w  D2,D7
                sub.w   #hither,D7      ; Z1-Zmax
                sub.w   D2,D5           ; Z2-Z1
                cmp.w   D7,D6           ; (Zmax-Z2 > Z1-Zmax)?
                bgt.s   z_case2_1
                neg.w   D7              ; Now Zmax-Z1

                sub.w   D0,D3           ; X2-X1
                muls    D7,D3
                divs    D5,D3
                add.w   D3,D0           ; Add to X1

                sub.w   D1,D4           ; Y2-Y1
                muls    D7,D4
                divs    D5,D4
                add.w   D4,D1           ; Add to Y1

                bra.s   z_tricont1

z_case2_1:      sub.w   D3,D0           ; X1-X2
                muls    D6,D0
                neg.w   D5              ; Now Z1-Z2
                divs    D5,D0
...
z_tricont1:     asl.w   #3,D0           ; Scale up.
                asl.w   #3,D1           ; Scale up.
                add.w   #scx,D0         ; Add screen's X center.
                add.w   #scy,D1         ; Add screen's Y center.
                move.w  D0,(A1)+        ; Store screene'd X.
...
z_tricont2:     asl.w   #3,D0           ; Scale up.
                asl.w   #3,D1           ; Scale up.
                add.w   #scx,D0         ; Add screen's X center.
                add.w   #scy,D1         ; Add screen's Y center.
                move.w  D0,(A1)+        ; Store screene'd X.

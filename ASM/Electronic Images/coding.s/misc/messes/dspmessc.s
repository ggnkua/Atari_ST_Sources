...
letsgo		MOVE.L 4(SP),A5
		...
		BSR wait_vbl
		BSR SetScreen
		MOVE.W #STMODES+VERTFLAG+VGA+BPS4,-(SP)
		MOVE.W #$58,-(SP)
		TRAP #14
		ADDQ.L #4,SP
		BSR cpy_pic		
...
dsp_mess        move.b #2,$ffff8934.w
		move.b #2,$ffff8935.w
		move.b  #3,$FFFF8936.w
                move.b  #2,$FFFF8937.w
                move.b  #0,$FFFF8938.w

                move.w  #%0100110010011011,D0 
                move.w  D0,$FFFF8932.w

                move.w  #%0000000011010101,D0 ; 
		...
		BSET.B #7,$FFFFFA13.W
                ...
                move.b  #2,$FFFF8900.w  ; interrupt at end of record(write) 
                move.b  #16,$FFFF8901.w  ; start dma.
		not.l $ffff9800.w

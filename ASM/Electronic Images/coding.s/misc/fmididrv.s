...
wait:	
	...
	move.w	d0,sndcount
	move.l	a0,sava0
	movem.l	d1/d7/a1-a3,savregs
	movem.l	(sp)+,d0/d1/d7/a0-a3
	move.l	#waitint,$134.w
	clr.b	acon.w
	move.b	#200,adat.w
	move.b	#1,acon.w
	rte
...
intcont:
	movem.l	d0/d1/d7/a0-a3,-(sp)
	movem.l	savregs(pc),d1/d7/a1-a3
...
loadm:	move.l	a0,-4(a1)
	move.l	d0,-4(a2)
	dbra	d7,dodels
brexit:	movem.l	(sp)+,d0/d1/d7/a0-a3
	move.w	#$000,$ffff8240.w
	RTE
...
waitint:
	...
	move.l	#myta,$134.w
	move.l	sava0(pc),a0
	move.b	savdat(pc),adat.w	;A data
	move.b	savcon(pc),acon.w	;A control clr.b = RESET, else 1-7 Subdiv
	bra	intcont
notrdy:	RTE

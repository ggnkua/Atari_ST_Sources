...
sealev	equ	3971	;sea level
start	equ	10002	;seed value/number of piccys.. ( <prime)
ht1	equ	7	;these are offsets from sea-level
ht2	equ	14
ht3	equ	21
ht4	equ	28
ht5	equ	35
...
fl_done:
		...
		addq	#2,sp
                ...
                move.w  #$77,$FFFF8242.w
                move.w  #$77,$FFFF8244.w
...
;#############################
;instead of plot..
;d4=x, d5=z, d0=col, yheight=y
;from  x,z/2 to x,z/2+y
vline   movem.l	d0-d7/a0-a6,-(sp)
	move.w	yheight(pc),d7
	lsr.w	#1,d7	;flatten it..
	lsr.w	#1,d5	;z/2
	move.w	d5,d6
	lsr.w	#1,d5	;z/4
	add.w	d6,d5	;z*3/4

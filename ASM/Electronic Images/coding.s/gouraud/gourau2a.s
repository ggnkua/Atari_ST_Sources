...
; 				 by Martin Griffiths July/August 1993	;
;									;
; - Interpolation with "Moire" dither shading				;
;									;
;-----------------------------------------------------------------------;
...
.norm_lp	MOVEM.W (A1)+,D0-D2	; x,y,z
		...
		BPL.S .ok
		CLR D2
.ok		MOVE.W D2,(A2)+		; store intensity
		DBF D4,.norm_lp
...
Do_left		MOVE D7,D6
Left_lp 	SUBQ #6,A5
		MOVEM.W (A5),D1-D2		;x1,y1
		MOVEM.W 4(A5),D0/D3-D5		;I2,x2,y2,I1
		SUB D4,D2			;dy
		BEQ.S .nonetodo
		SUB D3,D1			;dx
		SUB D5,D0			;DI
		...
		MOVE.L D3,-2(A3)		; x1
		MOVE.L D5,-2(A3)		; i1
.nonetodo	SUB D2,D6			; remaining lines-dy
		BGT.S Left_lp

; Calc x's down right side of poly

Do_right	MOVE.W D7,D0
Right_lp	MOVEM.W (A4)+,D1-D2/D5		;x1,y1,I1
		MOVEM.W (A4),D3-D4/D6		;x2,y2,I2
		SUB D2,D4			;dy
		BEQ.S .nonetodo
		SUB D1,D3			;dx
		SUB D5,D6			;DI
		...
		MOVE.L D1,-2(A3)		; x1
		MOVE.L D5,-2(A3)		; i1
.nonetodo	SUB D4,D0			;remaining lines-dy
		BGT.S Right_lp
...
G_Sequence	
		...
		DC.W SetFadeIn
		DC.L pal5,currpal
		DC.W SetXYZstuff,115,$cccc,$9999,$eeee,0,0,-30

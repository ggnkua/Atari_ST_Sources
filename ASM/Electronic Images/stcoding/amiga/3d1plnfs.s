...
; ( 1 Plane version with very limited object variation but fast!!!)	;
;-----------------------------------------------------------------------;		 
...
;		move.l (a0),a0
;		move.l (a0),a0
;		move.l $26(a0),(a1)+		; save old copper list ptr
;		move.l $6c.w,(a1)+		; save old vbl 
;		moveq #$f,d1
;		move.w $02(a6),d0
;		bset d1,d0
;		move.w d0,(a1)+			; save dma control
;		move.w $1c(a6),d0
;		bset d1,d0
;		move.w d0,(a1)+			; save int enable
...
Show_object	TST switch
		BEQ.S .cse1
		MOVE.L #clear1,clearsave_ptr
		BRA.S .cse2
.cse1		MOVE.L #clear2,clearsave_ptr
.cse2		BSR Matrix_make			; rotmat 
...
; Fill a 1 plane polygon. a5 -> d0 vertices.
...
.fillit		MOVE.W .max_y+2(pc),d1
		...
		MOVE.W D3,(A0)+
		MOVE.W D0,(A0)+
		MOVE.L A0,clearsave_ptr
.endoffill	RTS

clearsave_ptr	DC.L clear1
clear1		DC.L -1
		DS.L 99
clear2		DC.L -1
		DS.L 99

clearpolys	LEA clear1(PC),A0
		TST switch
		Bne.S .cse2
		LEA clear2(PC),A0
.cse2		waitblit
.lp		MOVE.L #$01000002,BLTCON0(A6)
		MOVE.L (A0)+,D5
		BMI.S .endclr
		waitblit
		MOVE.L d5,BLTDPT(A6)
...
cube		DC.W 0,0,0 
		...
		DC.W -800,800,800 
		DC.W 6 
		DC.W 01*40,4,04*4,07*4,03*4,00*4 
		DC.W 01*40,4,02*4,06*4,05*4,01*4 
		DC.W 00*40,4,03*4,07*4,06*4,02*4 
		DC.W 00*40,4,01*4,05*4,04*4,00*4 

		DC.W 02*40,4,03*4,02*4,01*4,00*4 
		DC.W 02*40,4,06*4,07*4,04*4,05*4 
...
thargoid	DC.W 0,0,0	 
		...
		DC.W -252*4,252*4,-100*4 
		DC.W 10 
		DC.W 0*40,8,00*4,01*4,02*4,03*4,04*4,05*4,06*4,07*4 
		DC.W 0*40,8,15*4,14*4,13*4,12*4,11*4,10*4,09*4,08*4 
		DC.W 1*40,4,06*4,14*4,15*4,07*4 
		DC.W 2*40,4,05*4,13*4,14*4,06*4 
		DC.W 1*40,4,04*4,12*4,13*4,05*4 
		DC.W 2*40,4,03*4,11*4,12*4,04*4 
		DC.W 1*40,4,02*4,10*4,11*4,03*4 
		DC.W 2*40,4,01*4,09*4,10*4,02*4 
		DC.W 1*40,4,00*4,08*4,09*4,01*4 
		DC.W 2*40,4,07*4,15*4,08*4,00*4 
...
station		DC.W 0,0,0 
		...
		DC.W -200,200,0 
		DC.W 14 
		DC.W 00*40,3,00*4,01*4,02*4 
		DC.W 01*40,3,09*4,11*4,10*4 
		DC.W 02*40,3,04*4,08*4,09*4 
		DC.W 01*40,3,01*4,03*4,08*4 
		DC.W 02*40,3,03*4,07*4,11*4 
		DC.W 01*40,3,00*4,05*4,07*4 
		DC.W 00*40,3,05*4,06*4,10*4 
		DC.W 01*40,3,02*4,04*4,06*4 
		DC.W 02*40,4,00*4,02*4,06*4,05*4 
		DC.W 01*40,4,04*4,02*4,01*4,08*4 
		DC.W 02*40,4,00*4,07*4,03*4,01*4 
		DC.W 01*40,4,07*4,05*4,10*4,11*4 
		DC.W 00*40,4,08*4,03*4,11*4,09*4 
		DC.W 02*40,4,06*4,04*4,09*4,10*4 
...
asteriod	DC.W 0,0,0 
		...
		DC.W 14*40,3,01*4,00*4,02*4 
		DC.W 15*40,3,02*4,00*4,05*4 
		DC.W 01*40,3,02*4,05*4,06*4 
		DC.W 10*40,3,02*4,06*4,04*4 
		DC.W 11*40,3,04*4,06*4,09*4 
		DC.W 13*40,3,04*4,09*4,08*4 
		DC.W 10*40,3,01*4,04*4,08*4 
		DC.W 01*40,3,03*4,01*4,08*4 
		DC.W 09*40,3,00*4,01*4,03*4 
		DC.W 10*40,3,07*4,11*4,10*4 
		DC.W 13*40,3,00*4,07*4,05*4 
		DC.W 01*40,3,10*4,05*4,07*4 
		DC.W 10*40,3,06*4,05*4,10*4 
		DC.W 09*40,3,06*4,10*4,09*4 
		DC.W 14*40,3,09*4,10*4,11*4 
		DC.W 15*40,3,08*4,09*4,11*4 
		DC.W 10*40,3,03*4,08*4,11*4 
		DC.W 01*40,3,03*4,11*4,07*4 
		DC.W 11*40,3,00*4,03*4,07*4 
...
screen1		ds.l no_planes*10*256
screen2		ds.l no_planes*10*256

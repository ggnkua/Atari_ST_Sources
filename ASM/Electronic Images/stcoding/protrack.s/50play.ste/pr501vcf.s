...
move1chan	MOVE.L voltab_ptr(PC),D1
		...
		MOVE.L Vfrac(A5),D2		; frac.w offset
		...
		TRAP #12
bufoff		LEA 1(A4),SP
.move1lp	MOVE.B (A0,D0.L),D1
		MOVE.L D1,A1
		MOVE.B (A1),D1
		MOVE.B D1,(SP)+
		MOVE.B D1,(SP)+
		ADD.L A2,D2		; 32 bit fraction
		ADDX.W D3,D0
		BCC.S .nolpvc1
		EXT.L D0
		MOVE.L A3,A0
...
.nolpvc1	DBF D6,.move1lp
		...
		MOVE.L D2,Vfrac(A5)		; store frac part
		RTS

; Create 2 channels in the buffer.

add1chan	MOVE.L voltab_ptr(PC),D1
		MOVEQ #0,D4
		MOVE.W Vvoltab(A5),D4
		ADD.L D4,D1			; volume tab chan 1
		MOVE.L Vaddr(A5),A0		; ptr to end of each sample!
...
testfilename	DC.B "h:\mods\velomat*.MOD"
endtestfilename
		ENDC

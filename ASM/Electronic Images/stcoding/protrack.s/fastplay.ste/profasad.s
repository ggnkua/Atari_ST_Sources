;-----------------------------------------------------------------------;
; 7 Bit ProTracker Driver (With padded samples)    			;
; By Griff of Electronic Images						;
; But this one does 50khz with full voluming on a standard STE.(95%)	;
;-----------------------------------------------------------------------;
...
Set_DMA		MOVE.L stebuf_ptrs,A0
		MOVE.L stebuf_ptrs+4,stebuf_ptrs
...
do2channels	MOVE.L SP,oldsp
		...
		MOVEM.L A0/A2,saveem

.vc2		MOVEM.W aud_period(A2),D6/D7	; freq(amiga period)/vol
		EXT.L D7
		ASL.W #8,D7
...
.vc1		MOVEM.W aud_period(A0),D2/D3	; freq(amiga period)/vol
		EXT.L D3
		ASL.W #8,D3
...
module 		INCBIN E:\MODS\KLISJE.MOD

...
; Interleaved sample mixing version. 40% cpu at 25khz with full voluming;
;-----------------------------------------------------------------------;

;bufsize 	EQU 125
;padsize 	EQU 700
;dmamask 	EQU %00000001
;freqconst	EQU $8EFE3B*4
...
do2channels	MOVEM.W aud_period(A2),D2/D3	; freq(amiga period)/vol
		EXT.L D3
		ASL.W #8,D3
		...
		AND.W #$FF,D2
		MULU #(bufsize*10)+6,D2
		LEA (A3,D2.L),A0
		JSR (A0)
		ADD.L (bufsize*10)+2(A0),D0
		CMP.L endoffy(A2),D0
		BLT.S .ok1
		SUB.W suboffy(A2),D0
...
module 		INCBIN E:\MODS\after_rn.MOD

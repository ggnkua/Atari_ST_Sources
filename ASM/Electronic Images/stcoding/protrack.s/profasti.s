...
;-----------------------------------------------------------------------;
;									;
;          7 Bit Ste Pro-Tracker Driver (With padded samples) 		;
;             (C) May 1992 Griff of Electronic Images			;
;									;
; Does ALL pro-tracker commands, i.e all E commands etc,finetune etc	;
;									;
;-----------------------------------------------------------------------;
;-----------------------------------------------------------------------;
...
.vc1		MOVEM.W aud_per(A0),D2/D3	; freq(amiga period)/vol
		...
		REPT bufsize/2
		MOVEQ #0,D7
		MOVE.B (A1,D0.L),D7		;v1 byte 1
		MOVE.W D7,D3
		SUB.B 1(A1,D0.L),D3		;v1 byte 2
		MOVE.L D1,A5
		;lsr.w #1,d1
		MULU D1,D3
		SWAP D3
		...
		EXT.W D7
		SUB.W D3,D7
		MOVE.B (A0,D7.W),D1		; first byte(volume converted)
...
;		ADD.B D3,D3
;		SUB.B D3,D7
;		ADD.B (A2,D7.w),D1		; +second byte(volume converted) 
;		ADD.W D5,D5
;		ADD.B #$80,D1
		MOVE.B D1,(A7)+			; store
		MOVE.L A5,D1
...
module 		INCBIN h:\MODS\cebit90.MOD

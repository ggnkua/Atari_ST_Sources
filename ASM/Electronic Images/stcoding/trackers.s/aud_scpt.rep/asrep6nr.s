...
* This Version uses no registers at all!!

player	equ $e0000
__OUTPUT	equ 0
ASreplayIrqFrq	equ 35		; timer speed(base freq)
...
AS50HzIrq	movem.l d0-d6/a0-a3/a5-a6,-(a7)
	not.w $ffff8240.w	
	bsr ASreplay
	bsr ASconvert
	bsr ASreplayDriver

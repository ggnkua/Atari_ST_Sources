...
;									;
; -  Moire Interpolation V2... (can be faster)  			;
;									;
;-----------------------------------------------------------------------;
...
; Setup a Quick clear screen routine. 

MakeFastClsRout	LEA FastClsList,A0
		MOVEM.L clearscri(PC),D0-D1
		MOVE #571-1,D3
...
clearscri	MOVEM.L D0-D7/A1-A6,-(A0)
		MOVEM.L D0-D5,-(A0)
...
pal	  	DC.W  $000,$103,$203,$303,$403,$503,$603,$703
		DC.W  $000,$210,$320,$431,$532,$643,$764,$775

...
gemrun		EQU 0		; 0 = run from gem
				; 1 = no gem calls	
maxpoints	EQU 270		; Max for 50Hz=408
...
points: 	include donut.cap

		;include d:\3d.s\newnomul.3d\gridpolr.pod
		;include d:\3d.s\newnomul.3d\cubepolr.pob
		;include d:\3d.s\newnomul.3d\spiral.pob

;Trigonometric tables

trig_tab: 	incbin d:\3d.s\newnomul.3d\trig1d.dat ; 65k cosine table.
sin:		equ	trig_tab+(3*8192)
cos:		equ	trig_tab+(4*8192)
trig:	  	incbin d:\3d.s\newnomul.3d\trig2d.dat ; 65k arccosine table.

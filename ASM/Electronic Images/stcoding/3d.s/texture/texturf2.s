...
; 				    by Martin Griffiths Febuary 1993	;
;									;
;-----------------------------------------------------------------------;
...
; Setup a Quick clear screen routine. A0-> addr to place rout.

MakeFastClsRout	MOVEM.L clear1scrline(PC),D0-D2
		MOVE #200-1,D3
.mfcl_lp	MOVE.L D0,(A0)+
		MOVE.L D1,(A0)+
		MOVE.L D2,(A0)+
		DBF D3,.mfcl_lp
		MOVE.W #$4E75,(A0)
...
clear1scrline	MOVEM.L D0-D7/A1-A6,-(A0)
...
Left_lp 	SUBQ #4,A4
		...
		MULS (a0,d2),d4			; dx gradient
		ADD.L D4,D4
		MULS (A0,D2),D5			; dy gradient
		ADD.L D5,D5
		EXT.L D6
		EXT.L D7
		SWAP D6
		...
		MULS (A0,D2),D1			; DX* 1/dy
		ADD.L D1,D1
		MOVE.W D1,D0			; frac part
		SWAP D1				; whole part
...
Do_right	MOVE.W (SP),D7
		MOVE.L A1,A6
		LEA x2s(PC),A3
Right_lp	MOVEM.W (A5)+,D1-D2		;x1,y1,I2
		MOVEM.W (A5),D3-D4		;x2,y2,I1
		SUB D2,D4			;dy
		SUB D1,D3			;dx
		...
		MOVEM.W (A6),D0/d5/d6/D7	; source x1,y1,x2,y2
		ADDQ.W #4,A6
		SUB.W d0,D6			; source dx
		SUB.W d5,D7			; source dy
		MULS (a0,d4),d6			; dx gradient
		ADD.L D6,D6
		MULS (A0,D4),D7			; dy gradient
		ADD.L D7,D7
		ext.l d0
		ext.l d5
		SWAP D0
...
tdraw_lp    	MOVEM.W (A1)+,D0-D2		; x1,sx1,sy1
		...
		MOVE.W D3,D6
		ADD.W D6,D6
		MULS (A0,D6),D4			; sdx / dx
		MULS (A0,D6),D5			; sdy / dx
		ADD.L D4,D4
		ADD.L D5,D5
		MOVE.L D4,A3
		MOVE.L D5,A4
...
test_cols	LEA pic1+34,A0
		LEA convdpic1,A1

		MOVE #200-1,D1		
.y1_lp		MOVEQ #16-1,D0
.x1_lp		MOVEM.W (A0)+,D2/D3/D4/D5	; fetch bpl 1-4
		REPT 16	
		do1tst
		ENDR
		DBF D0,.x1_lp			
		...
		DBF D1,.y1_lp
		RTS
pic1		INCBIN wood2.PI1
	
		SECTION BSS
FastClsList	DS.L (200*3)+1

...
;-----------------------------------------------------------------------;
; Fastest Half meg version - 256k lookup with (y * 160) builtinto table!
...
switch		DS.W 1
vbl_timer	DS.W 1
colours		DC.W $000,$777,$666,$666,$444,$444,$444,$444
...
star_seq	DC.W 128,0,0,56,0,128
		;DC.W 256,4,4,56,0,128
		DC.W 256,4,4,0,56,128
		DC.W 256,4,4,56,56,128
		DC.W -1
...
.cse1		MOVE.L A4,A3
.cse2		
		MOVE.L log_base(pc),d2		; screen base
		LEA stars_rel,A1		; star co-ords
		ADD.W D5,A1

		MOVE.W #$FF8,D7
		LEA stars,A2			; star co-ords
		MOVEM.W (A2,D5),D0-D1
		ADD.W D3,D0
		ADD.W D4,D1
		AND.W D7,D0

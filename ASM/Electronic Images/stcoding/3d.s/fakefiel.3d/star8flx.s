...
clear_stars	MOVE.L log_base(pc),A0		; screen base
		...
		TST switch
		BNE old_pos1
old_pos2	REPT no_strs
		MOVE.W D0,2(A0)
		ENDR
		RTS
old_pos1	REPT no_strs
		MOVE.W D0,2(A0)
		ENDR
		RTS
...
star_seq	DC.W 128,0,0,1768,0,40
		DC.W 256,4,4,1768,0,48
		DC.W 256,4,4,0,1768,48
		DC.W 256,4,4,1768,1768,48
		DC.W -1
...
.nonew		MOVEM.W xyzang(A6),D0-D1
		...
		LEA perstab,A2
		ADD.W D5,A2
		LEA mul_160+384(PC),A4		; mul 160 table
		LEA plot_masks+(384*2),A5	; point masks
		LEA old_pos1(PC),A3		
		TST switch
		BNE .cse2
.cse1		LEA old_pos2(PC),A3		
.cse2		MOVE.L (A3),D6
		MOVE #no_strs-1,D5
.lp		MOVEM.W (A1)+,D0-D2
		ADD D3,D0

;-----------------------------------------------------------------------;		
; 3D 1 PLANE Object Rotation routine V1.0(STE) by Martin Griffiths 									;
; STE Blitter Usage for Hline etc.
;-----------------------------------------------------------------------;		
...
wait_vbl	CMP (A0),D0
		...
		MOVE #$000,$FFFF8240.W
		ENDC
clearscreen	LEA $FFFF8A00.W,A5
		MOVE.L D7,A0
		LEA 16(A0),A0
		MOVE.L A0,dst_addr(A5)
		MOVE.W #2,dst_xinc(A5)
		MOVE.W #34,dst_yinc(A5)
		MOVE.B #0,HOP(A5)
		MOVE.B #0,OP(A5)
		MOVE.W #64,x_count(A5)
...
drawonehline:	
		...
		MOVE.L A6,A0
		ADD.W D0,A0
		SUB D0,D1			; difference!
		BGT.S .multi
		BMI.S next_line			; same chunk?
		AND.L D0,D1
		SWAP D1
		MOVE.L A0,dst_addr(A5)
		MOVE.W D1,endmask1(A5)
		MOVE.L D2,x_count(A5)
		MOVE.B D3,line_num(A5)
		BRA.S next_line
.multi		SWAP D0
		MOVE.L A0,dst_addr(A5)
		MOVE.W D0,endmask1(A5)
		LSR #3,D1
		ADDQ #1,D1
		MOVE.W D1,x_count(A5)
		MOVE.W D2,y_count(A5)
		SWAP D1
		MOVE.W D1,endmask3(A5)
		MOVE.B D3,line_num(A5)

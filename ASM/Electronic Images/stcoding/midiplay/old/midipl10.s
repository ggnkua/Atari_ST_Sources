...
.foundit	move.w	20(a2),d5
		...
		move.l	16(a2),d0		; sample loop end offset 
		LEA	96(a2),a2
		LEA.L	(A2,D0.L),A1		; a1-> sample end
		MOVE.L	A1,cur_base(A5)
		LSR.L	#1,D0
		NEG.L	D0
		MOVE.L	D0,cur_posint(A5)
		NEG.L	D0
		CLR.L	cur_posfrac(A5)
		btst.b	#2,55-96(a2)
		Beq.S	.noloop
		MOVE.L	12-96(a2),d1
		LSR.L	#1,D1
		SUB.L	D1,D0
		MOVE.L	D0,cur_lplen(A5)
		BRA.S	.cont
.noloop		MOVE.L	#-1,cur_lplen(A5)
.cont		move.l	d3,d4	
		clr.w	d4
		swap	d4
...
pre_div		EQU 4			; pre divider(frequency)
...
do_vce		MOVE.L cur_base(A1),A0		; current voice address
		MOVEM.L	cur_posint(A1),D0/D2
		MOVE	#0,CCR
		BRA.S	.madecont
.madeuploop	
		MOVE.W (A0,D0.L*2),(A6)
		ADD.L	D4,D2
		ADDX.L	D3,D0		
.madecont	DBCS D5,.madeuploop
		BCC.S	.vce_done
		SUB.L	cur_lplen(A1),D0
		BGE.S	vce_isoffcont
		MOVE	#0,CCR
		BRA.S	.madecont

.vce_done	MOVEM.L	D0/D2,cur_posint(A1)
exit_send	RTS
...
tune		INCBIN D:\MUSIC.MID\tinytoon.MID
		;NCBIN D:\MUSIC.MID\j.MID
		;INCBIN D:\MUSIC.MID\midipc_5.MID
		EVEN

...
no_channels	EQU	32		; No. of Voices
midi_record	EQU 	0
...
.lp2		tst.b	voice_used(a5)
		...
		cmp.b	assoc_inst_no(a5),d6
		bne.s	 .next2
		cmp.w	#3,cur_env_offset(a5)
		blt.s	.next2
		cmp.l	#3000,cur_ramp_vol(a5)
		blt.s	.okfoundvoice
...
.justvol	TST.W	D3
		...
		bra	do_note_off
tabby		DC.W	512*15,64*15,8*15,1*15
...
.fix_lp		tst.b	voice_used(a1)
		beq.s	.next3
		move.l	cur_intfrac(a1),d1
		mulu.l	#$f0000,d0:d1
		divu.l	d6,d0:d1		
		move.l	d1,cur_intfrac(a1)

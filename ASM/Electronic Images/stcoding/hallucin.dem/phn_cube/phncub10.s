...
Enigma_cube	LEA vbl_timer(PC),A6
.wait1		MOVE.W (A6),D0
		BEQ.S .wait1
		BSR Swapscreens
...
; Make poly filling routs (e.g duplicate 2 hlines routs 200 times!!)

makepolyf	MOVE #199,D7
		LEA hliner1,A1
.mpflp2a	LEA drawonehline(PC),A0
...
.notnegy	MOVE.W D2,D4
		...
		LEA bit_offs,A2			;point to mask and offset table
...
hliner1		DS.W 200*(hlinesize/2)  ; Normal 1 plane solid poly fill
poly_done1	DS.W 1
ch_vectl	DS.L 320
ch_vectr	DS.L 320
perstab		DS.W $A00

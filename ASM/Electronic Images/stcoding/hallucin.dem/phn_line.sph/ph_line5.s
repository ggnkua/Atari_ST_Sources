...
.gofordraw	MOVEQ #15,D5			;
		...
		LEA 8(A2),A6
		NEG.W D3
.posdy		MOVE.L A1,A0			; a0-> screen base
		ADD.W D1,D1			; y*2
		ADD.W (A3,D1),D0		; scr offset
		ADD.W D0,A0			; scrbase
.sizeline	MOVE.W D3,D4			; assume dy biggest
		CMP.W D2,D3
		BGE.S .dyok
		MOVE.W D2,D4 
.dyok		ADD.W D4,D4
		MOVE.W .jmptabn(PC,D4),D4
		JMP .jmptabn(PC,D4)
.jmptabn		
		REPT 16
		dc.w .line16p-.jmptabn
		ENDR
		rept 16
		dc.w .line32p-.jmptabn
		endr
		rept 16
		dc.w .line32p-.jmptabn
		endr

.line16p	LSL.W #4,D3			; dy*16
		ADD.W D3,D2			; x + dy 
		LSL.W #4,D2
		ADD.W D5,D2
		LSL.W #4,D2
		MOVEM.L (A6,D2.l),D2/A1
		JMP (A1)

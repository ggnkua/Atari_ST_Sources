...
* Matrix(3,3) cosz*cosx
		...
		LEA smmat_tmp(PC),A5
		LEA .MO4_1+2(PC),A6
		MOVE.W	(A5)+,.MO4_1-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_2-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_3-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_4-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_5-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_6-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_7-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_8-.MO4_1(A6)
		MOVE.W	(A5)+,.MO4_9-.MO4_1(A6)
...
.posdy		ADD.W D1,D1			; y*2
		...
		ADD.W D0,A0			; scrbase
		ASL.W #5,D3			; dy*16
		ADD.W D3,D2			; x -- dy (so x+dy!!)
		ADD.W D2,D2
		ADD.W D2,D2
		MOVE.L (A2,D2.W),A1
		MOVE.L (A1)+,x_count(A6)	; x_count\y_count
		SUB (A1)+,D4
		MOVE.W D4,dst_yinc(A6)
		MOVE.L A1,src_addr(A6)
		MOVE.L A0,dst_addr(A6)
		OR.W D7,D5
		MOVE.W D5,line_num(A6)	
		RTS
...
; Convert shape to a faster form!

conv_shp	LEA obj(PC),A0
		LEA bigtable+($7F7F*2),A1		; big MAT lookup
		LEA fast_obj,A2
		MOVE.W (A0)+,D0
		MOVE.W D0,(A2)+
.lp		

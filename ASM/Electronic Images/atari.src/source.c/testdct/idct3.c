...
void idct3 (short *block)
{
  ...
  for (ctr = DCTSIZE; ctr > 0; ctr--) {
    ...
    */
    ...
    tmp6 = MULTIPLY(z10, - FIX_2_613125930) + z5 - tmp7 ; /* -2*(c2+c6) */
    wsptr[DCTSIZE*0] = (tmp0 + tmp7);
    wsptr[DCTSIZE*7] = (tmp0 - tmp7);
    tmp5 = MULTIPLY(z11 - z13, FIX_1_414213562) - tmp6; /* 2*c4 */
    tmp4 = MULTIPLY(z12, FIX_1_082392200) - z5 + tmp5 ; /* 2*(c2-c6) */

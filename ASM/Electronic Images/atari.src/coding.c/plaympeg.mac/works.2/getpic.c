...
static void clearblock _ANSI_ARGS_((INT32 comp));
static void sumblock _ANSI_ARGS_((INT32 comp));
static void addblock _ANSI_ARGS_((INT32 comp, INT32 bx, INT32 by,
  INT32 dct_type, INT32 addflag));
...
{
  INT32 comp;
  INT32 MBA, MBAmax, MBAinc, mb_type, cbp, motion_type, dct_type;
  INT32 slice_vert_pos_ext;
  INT32 bx, by;
  UINT32 code;
  INT32 dc_dct_pred[3];
...
INT32 comp,bx,by,dct_type,addflag;
{
  INT32 cc,i, j, iincr;
  unsigned char *rfp;
  INT16 *bp;

...
{		char *error[] =	{			"",
							...
							" NOT a valid QUICKTIME file\x0a\x0d",
							" Sorry, PLAY QUICKTIME does not run in Mono!\x0a\x0d",
						};
		Cconws(error[n-1]);
		wait_key();
		exit(n);
...
{ 
  void *old_stack;
  long flength,res;
  Cconws("\33E\33f PLAY QUICKTIME v0.1\x0a\x0d");
#ifndef REGISTERED

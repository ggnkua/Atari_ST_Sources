...
/*#pragma aux showbits parm [eax] modify [eax];*/
void idct(INT16*);
...
extern void getintrablocks(INT16);
...
EXTERN INT16 fault,quiet;
EXTERN INT16 pict_type;
EXTERN UINT32 ld_incnt;
EXTERN unsigned char *ld_rdptr;
EXTERN unsigned char *ld_rdmax;
EXTERN unsigned char ld_rdbfr[8192+4];

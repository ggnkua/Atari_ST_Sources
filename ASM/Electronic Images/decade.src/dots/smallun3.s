...
*
* This one (3) uses annuver way of plotting pointz - faster?
*
...
cxs:	move.w	d0,d1			* Get X coordinate for offset.
	...
	move.l	#317,x2		* Destination X (< so a shrink).
	move.l	#199,y1		* Source X.
	move.l	#197,y2		* Destination X (< so a shrink).
	move.l	y2(pc),d0
	mulu	#160,d0
	move.l	d0,ymult
...
key:	
	...
	move.l	d6,a1			* Get X address of offsets/data.
	add.w	d0,d0
...
col0:	bra	cont1			* Colour 0.
col1:	or.w	d0,(a0)
	bra	cont1			* Colour 1.
col2:	or.w	d0,2(a0)
	bra.s	cont1			* Colour 2.
col3:	or.w	d0,(a0)
	or.w	d0,2(a0)
	bra.s	cont1			* Colour 3.
col4:	or.w	d0,4(a0)
	bra.s	cont1			* Colour 4.
col5:	or.w	d0,(a0)
	or.w	d0,4(a0)
	bra.s	cont1			* Colour 5.
col6:	or.w	d0,2(a0)
	or.w	d0,4(a0)
	bra.s	cont1			* Colour 6.
col7:	or.w	d0,(a0)
	or.w	d0,2(a0)
	or.w	d0,4(a0)
	bra.s	cont1			* Colour 7.
col8:	or.w	d0,6(a0)
	bra.s	cont1			* Colour 8.
col9:	or.w	d0,(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 9.
col10:	or.w	d0,2(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 10.
col11:	or.w	d0,(a0)
	or.w	d0,2(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 11.
col12:	or.w	d0,4(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 12.
col13:	or.w	d0,(a0)
	or.w	d0,4(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 13.
col14:	or.w	d0,2(a0)
	or.w	d0,4(a0)
	or.w	d0,6(a0)
	bra.s	cont1			* Colour 14.
col15:	or.w	d0,(a0)+
	or.w	d0,(a0)+
	or.w	d0,(a0)+
	or.w	d0,(a0)

...
cloop:	move.l	d1,(a0)+
	...
	move.w	#16,count		* Number of times for shrink
	move.l	#4,shrx			* Step for shrink X.
	move.l	#2,shry			* Step for shrink Y.
	...
	move.l	#56,y1			* Source size Y.
	move.l	#56,y2			* Destination sz Y (< so a shrink).
	move.w	#16,count		* 15 times pleez.
	move.l	#5,shrx			* Step for shrink X.
	...
	move.l	#56,y1			* Source size Y.
	move.l	#56,y2			* Destination sz Y (< so a shrink).
	move.l	#3,shrx			* Step for shrink X.
	move.w	#16,count		* 15 times pleez.

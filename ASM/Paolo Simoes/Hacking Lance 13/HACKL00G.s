***************************************************************************
*
* PROG: HACKING LANCE		version: 0.00G		date:	01/05/2013
*
*==========================================================================
* FUNCTION:
*	Allows Lance replay at 12.5 KHz / 25 KHz / 50 KHz for a MOD on STE.
* FILES:
*	- HACKL??G.PRG	this program
...
z_octave3_cheat	dc.w	$0001	Values 0 (no) 1 (active)
z_global_volume	dc.w	$BFFF	values $0000 (mute) to $FFFF (maximum)

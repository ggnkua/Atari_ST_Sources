...
; une gestion minmax meilleurs (les minmax ne sont plus de 16 en 16 mais de 1 en 1)
		...
		TEXT
fonte198	equ 0
interstice	equ 1	; interstice on ou off 	
...
; creation des couleurs de fonte
	...
	move.w #NBFONTECAR,d0				; 50 caractere
...
asciicar:
		dc.b 0		; 29 = 29iem car de la fonte si caractere pas connu ici c'est l'espace (le 30 iem car de la chaine qui suit est l'espace)
		dc.b ' !"#$%&''[]*+,-./0123456789:;<=>? abcdefghijklmnopqrstuvwxyz'
		dc.b 0
		even
;asciicar198:
		dc.b 48
		dc.b 'rstuvwxyz!?:;0123456789"(),-.+'' *'
		even
textescroll:
...
_toto4
	...
	move.l d0,(a1)+
_toto5
	move.w #$4ed4,(a1)+		jmp (a4) remplace le rts
...
.loop1
	...
	;add d1,a3
	add.w (a3,d1.w),d3	y*160 ;s /d0/d1
	;sub d1,a3
	move.l d3,d0
	add.l d4,d0
	move.l d7,a4
...
.loop1:
	...
	move.l a5,a2
	add d1,a2
	move.l (a2),d3  ; s/d1/d0			; d3 = numerocg, offset
	move.l a4,a2
	add d3,a2
	move.l (a2),(a6)+		; stoque dans buffer resultat: adresse code genere a appeler
	swap d3				; Y relatif (*160)
	lsr #1,d0	;s/d0/d1	; y*4 devient y*2
	move.l a3,a2
	add d0,a2
	add.w (a2),d3	y*160 ;s /d0/d1
	ext.l d3
...
_debug	equ  0 1
	...
	move.l #%10001000100010001010001000100010,d0
	move.l logscr,a0
	move.w #19,d7
.debug:
	jsr (a4)

...
tga24_to_ofsmap:
; Converts 24 bit uncompressed TGA to ofsmap data (B/G channels used for X/Y)
; in	d0.w	x-res
;	d1.w	y-res
;	a0	tga source
;	a1	dest
...
.x:		move.b	(a0)+,(a1)+
		...
		rts
tga24_to_ste12:
;Converts 24 bit uncompressed 24-bit TGA to STe colour data
;in	d0.w	x-res
;	d1.w	y-res
;	a0	tga source
;	a1	dest

		;lea	crosstw_gfx24+18+32*3*272,a0
		;lea	buf+crosstw_gfx12,a1
...
.x:
		...
		rts
.ste:		dc.b	$0,$8,$1,$9,$2,$a,$3,$b,$4,$c,$5,$d,$6,$e,$7,$f
.xc:		dc.w	0
.yc:		dc.w	0
...
text_stream:		dc.b	"- DMA stream initialized",13,10,0
			even

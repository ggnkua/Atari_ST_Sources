...
pistol_pfile	dc.b	"g:\running\tpi\chain.tpi",0
pistol_dfile	dc.b	"g:\running\data\chain.dat",0
...
anim_dat_0	dc.w	0,79		; linke untere ecke (x,y)
		dc.w	128,80		; absolute breite und hoehe
		dc.w	96		; screen_xoffi
		dc.w	%11		; flags:
					;  bit 0: waffe schwankt in x-richtung
					;  bit 1: waffe schwankt in y-richtung

anim_dat_1	dc.w	128,79		
		dc.w	128,80	
		dc.w	96
		dc.w	%11

anim_dat_2	dc.w	0,159	
		dc.w	128,80	
		dc.w	96
		dc.w	%11

anim_dat_3	dc.w	128,159		
		dc.w	128,80		
		dc.w	96
		dc.w	%11

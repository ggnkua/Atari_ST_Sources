...
is_get_next_free_sam
		...
		tst.w	dma_speech_flag
		beq.s	ignfs_normal

		clr.w	dma_speech_flag
		lea	spl_dat,a0
		lea	spl_dat_length*3(a0),a0
		bra	ignfs_found_free

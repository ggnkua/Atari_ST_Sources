...
init_sam_dist
	...
	; einfaches sample mit lautstaerkenanpassung
	...
	; welches sample: intern oder extern
...
init_sam_dist_ndl
	...
	; einfaches sample mit lautstaerkenanpassung
	; kann nicht mehrfach abgespielt werden ...
...
isdnd_extern
	...
	; sampledaten uebernehmen
		...
		add.w	d2,d2
		add.w	d3,d2
		adda.w	d2,a1		; a1 = neue sample adresse
...
init_sam_nd
	...
	; einfaches sample, ohne lautstaerkenanpassung,
	; kann nicht (!) mehrfach abgespielt werden
...
; rueckgabe: a0: entspr. spl_dat

; 1. moeglichkeit: es ist noch ein sampleplatz frei
; dazu alle plaetze auf leere plaetze durchgehen ...
...
; 2. moeglichkeit: das kuerzeste sample heraussuchen
...
; initialisiert den dma_player
; mit 25 kHz, mono, no surround

init_dma_play
		move.w	sr,-(sp)
		move.w	#$2700,sr	; keine interrupts

...
;ist oberhalb der textur decke, dann diese auch eintragen
		...
		btst	#11,x:line_flag_2	;oben ?
		jcc	strahl_vorbei

		btst	#10,x:line_flag_2	;unten auch?
		jcc	oben_nicht_unten
...
oben_nicht_unten
		...
		btst	#12,x:line_flag_2	;soll himmel statt
		jcc	no_clouds		;decke gezeichnet werden ...

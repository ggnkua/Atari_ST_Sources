...
*										*
* RAM_WT is a small tool that sets cache mode to Write Trough in page		*
* descriptors from logical address 0x00000000 up to the 1st invalid page	*
* descriptor or 1 GB RAM.							*
*										*

...
*										*
* TTRAM_WT is a small tool that sets cache mode to Write Trough in page		*
* descriptors from logical address 0x01000000 up to the 1st invalid page 	*
* descriptor, or the 1 GB RAM limit. (TT RAM area)				*
*										*

...
PALETTE:
	DC.W	$0000,$0110,$0010,$0120,$0350,$0240,$0130,$0020
	DC.W	$0242,$0011,$0012,$0022,$0047,$0036,$0025,$0014
...
SURFACE_LIST:
	DC.W	0*4,0,0,1*4,73,0,2*4,73,56*256,3*4,0,56*256
	DC.L	GFX_DATA
	DC.W	1*4,0,0,5*4,73,0,6*4,73,56*256,2*4,0,56*256
	DC.L	GFX_DATA
	DC.W	4*4,0,0,5*4,73,0,1*4,73,56*256,0*4,0,56*256
	DC.L	GFX_DATA
	DC.W	3*4,0,0,2*4,73,0,6*4,73,56*256,7*4,0,56*256
	DC.L	GFX_DATA
	DC.W	5*4,0,0,4*4,73,0,7*4,73,56*256,6*4,0,56*256
	DC.L	GFX_DATA
	DC.W	4*4,0,0,0*4,73,0,3*4,73,56*256,7*4,0,56*256
	DC.L	GFX_DATA
...
MAPPING_GFX:	INCBIN	n:\landgame.tlb\INTRO\TEXTURE\LOGO.OBJ

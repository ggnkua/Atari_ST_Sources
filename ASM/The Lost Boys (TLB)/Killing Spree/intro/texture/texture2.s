...
ADDIT	SET	0
	...
	MOVEM.L	D0-D7/A1-A6,ADDIT+56(A0)
ADDIT	SET	ADDIT+160
	ENDR
	RTS
...
SURFACE_LIST:
	DC.W	0*4,0,0,1*4,63,0,2*4,63,63,3*4,0,63
	DC.L	GFX_DATA
	DC.W	1*4,0,0,5*4,63,0,6*4,63,63,2*4,0,63
	DC.L	GFX_DATA+16384
	DC.W	4*4,0,0,5*4,63,0,1*4,63,63,0*4,0,63
	DC.L	GFX_DATA+32768
	DC.W	3*4,0,0,2*4,63,0,6*4,63,63,7*4,0,63
	DC.L	GFX_DATA
	DC.W	5*4,0,0,4*4,63,0,7*4,63,63,6*4,0,63
	DC.L	GFX_DATA+16384
	DC.W	4*4,0,0,0*4,63,0,3*4,63,63,7*4,0,63
	DC.L	GFX_DATA+32768
...
SINTAB	
	INCBIN E:\KSPREE.TLB\INTRO\TEXTURE\SIN_TAB.DAT"

...
;
; Image converter for 1byte/pixel BMP to 2 bitplane ST data
;
; Input
; * 8bit BMP
;
...
x:		equ	240		;image width, needs to be a multiple of 16
y:		equ	400		;image height
...
bmp:		incbin	'greets.bmp'
		even

		
snap_filesize:	dc.l	size

snap_filename:	dc.b	'greets.2pl',0
		even

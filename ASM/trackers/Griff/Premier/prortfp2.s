...
start_ints	LEA buffer(PC),A1
		LEA buff_ptr(PC),A0
		MOVE.L A1,(A0)
		LEA superswitch(PC),A0
		MOVE.L A0,$B0.W
		LEA ste_flag(PC),A0
		TST.B (A0)
		BEQ.S Setup_YM2149
.ste		LEA dma_go(PC),A0
		SF (A0)
		RTS
...
mt_initvc
	MOVE.W D0,n_note(A0)
	MOVE.W D0,n_cmd(A0)
	MOVE.B D0,n_cmdlo(A0)
	MOVE.L D0,n_start(A0)
	MOVE.W D0,n_length(A0)	
	MOVE.L D0,n_loopstart(A0)	
	MOVE.W D0,n_replen(A0)	
	MOVE.W D0,n_period(A0)	
	MOVE.B D0,n_finetune(A0)	
	MOVE.B D0,n_volume(A0)	
	MOVE.B D0,n_toneportdirec(A0)
	MOVE.B D0,n_toneportspeed(A0)
	MOVE.W D0,n_wantedperiod(A0)	
	MOVE.B D0,n_vibratocmd(A0)	
	MOVE.B D0,n_vibratopos(A0)	
	MOVE.B D0,n_tremolocmd(A0)	
	MOVE.B D0,n_tremolopos(A0)	
	MOVE.B D0,n_wavecontrol(A0)	
	MOVE.B D0,n_glissfunk(A0)	
	MOVE.B D0,n_sampleoffset(A0)
	MOVE.B D0,n_pattpos(A0)	
	MOVE.B D0,n_loopcount(A0)
	MOVE.B D0,n_funkoffset(A0)
	MOVE.L D0,n_wavestart(A0)
	MOVE.W D0,n_reallength(A0)
	RTS
...
.my_jmp		JMP $12345678
		...
		ADDX.W D6,D4	
		MOVE.B (A1,D0.L),D3
		MOVE.B (A5,D3.W),D7		; first byte(volume converted)
		MOVE.B (A6,D4.L),D3
		ADD.B (A4,D3.W),D7		; +second byte(volume converted) 
		MOVE.B D7,(SP)+			; store
		ENDR
.jmphere	LEA (SP),A4
		TRAP #12
...
mt_data1	incbin	d:\vert_may.hem\ingame.moP
mt_data2	incbin	d:\vert_may.hem\HEAVHELL.MOP
mt_data3	incbin	d:\vert_may.hem\sympathy.mop
mt_data4	incbin	d:\vert_may.hem\fullyan.moP

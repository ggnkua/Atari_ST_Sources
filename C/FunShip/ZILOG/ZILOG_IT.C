 ...
 *
 *
 *		Programme dÇmonstration IT- Terminal entre deux machines
 *
 *		Ce programme transfäre Ö 19200 Bits/Sec. en 8 Bits ParitÇ Paire
 *		1 bit de Stop.
 *		Il opäre en mode simple pour l'Çmission d'un caratäre
 *		mais reáoit sous interruption.
 *
 *
...
*/
{
  ...
  SCCPut(Channel,0x14,WR1);			/* ITs for every bytes and parity error */

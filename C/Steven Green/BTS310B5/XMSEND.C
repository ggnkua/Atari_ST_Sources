...
int cdecl XSInit (XMARGSP, int);
int cdecl XSEnd (XMARGSP, int);
int cdecl XSXmtStart (XMARGSP);
int cdecl XSXmTeStrt (XMARGSP);
int cdecl XSCheckACK (XMARGSP);
int cdecl XSSendBlk (XMARGSP);
int cdecl XSWaitEnd (XMARGSP);
...
int cdecl XSInit (args, start_state)
XMARGSP args;
int start_state;
{
	struct stat st;
...
int cdecl XSEnd (args, cur_state)
XMARGSP args;
int cur_state;
{
...
int cdecl ACInit (args, start_state)
XMARGSP args;
int start_state;
{
	args->result = 0;
...
int cdecl ACEnd (args, cur_state)
XMARGSP args;
int cur_state;
{
   args->result = cur_state;

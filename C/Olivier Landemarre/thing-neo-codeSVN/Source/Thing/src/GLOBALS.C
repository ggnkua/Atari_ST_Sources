...
POPMENU pop_short = { 0L, DAISHORT, DAISHORTS, 1, -1, 0, 0, -1, 0, NULL },
...
POPMENU pop_fkeyfd = { 0L, FLFKEY, FLFKEYS, 1, -1, 0, 0, -1, 0, NULL },
		pop_mem = { 0L, FLPMEM, FLPMEMS, 1, -1, 0, 0, -1, 0, NULL },
...
POPMENU pop_fkeydgi = { 0L, GIFUNC, GIFUNCS, 1, -1, 0, 0, -1, 0, NULL },
...
POPMENU pop_tcolor = { 0L, FOFCOL, FOFCOLS, 1, -1, 0, 0, -1, -1, NULL },
		pop_bcolor = { 0L, FOBCOL, FOBCOLS, 1, -1, 0, 0, -1, -1, NULL },
		pop_bpat = { 0L, FOBPAT, FOBPATS, 1, -1, 0, 0, -1, -1, NULL },
...
POPMENU pop_dcol = { 0L, CODCOL, CODCOLS, 1, -1, 0, 0, -1, -1, NULL },
		pop_dpat = { 0L, CODPAT, CODPATS, 1, -1, 0, 0, -1, -1, NULL },
		pop_autox = { 0L, COAUTOSIZEX, COAUTOSIZEXS, 1, -1, 0, 0, -1, 0, NULL },
		pop_autoy = { 0L, COAUTOSIZEY, COAUTOSIZEYS, 1, -1, 0, 0, -1, 0, NULL },
...
POPMENU pop_rez = { 0L, CRREZ, CRREZS, 1, -1, 0, 0, -1, 0, NULL },
		*rezpop[] = { &pop_rez, 0L };

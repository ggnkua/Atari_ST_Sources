...
#define GL_FAST_CALCULATIONS 0xCBCC; /* arbitraire pour calcul rapide */
#define DEBUG
/* #define NDEBUG */
enum {
...
/*	int fast_calculations;*/ /* si true alors calculs sur des entiers !!! */
  ...
  V4 current_color;
  unsigned int longcurrent_color[3]; /* valeurs pr‚calcul‚es des couleurs en entiers courante */
  V4 current_normal;

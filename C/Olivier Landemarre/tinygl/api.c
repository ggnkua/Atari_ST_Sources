...
void glColor4f(float r,float g,float b,float a)
{
  ...
  p[3].f=b;
  p[4].f=a;
  p[5].ui=(unsigned int)(r*  (ZB_POINT_RED_MAX - ZB_POINT_RED_MIN) + ZB_POINT_RED_MIN);  /* pour compilation va aller + vite ! */
  p[6].ui=(unsigned int)(g*(ZB_POINT_GREEN_MAX - ZB_POINT_GREEN_MIN) + ZB_POINT_GREEN_MIN);  /* pr‚calcule de la couleur sur 2 octets */
...
void glColor4fv(float *v)
{
  ...
  p[3].f=v[2];
  p[4].f=v[3];
  p[5].ui=(unsigned int)(v[0]*  (ZB_POINT_RED_MAX - ZB_POINT_RED_MIN) + ZB_POINT_RED_MIN);  /* pour compilation va aller + vite ! */
  p[6].ui=(unsigned int)(v[1]*(ZB_POINT_GREEN_MAX - ZB_POINT_GREEN_MIN) + ZB_POINT_GREEN_MIN);  /* pr‚calcule de la couleur sur 2 octets */

...
typedef Uint16  int2;   /* a two-byte int, use short.*/
typedef Uint32  int4;   /* a four-byte int, use int unless int is
...
int qmus2mid( void *mus, size_t len, SDL_RWops *rw /*FILE *file_mid*/,

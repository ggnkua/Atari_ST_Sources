/* BUILD - CPX, Stellt aus einem speziellen Programm ein CPX her				*/
...
struct foobar		/* ist normalerweise in "*.rsh" definiert und			*/
{						/* wird in "xcontrol.h" benîtigt								*/
	WORD	dummy;
	WORD	*image;
};
...
#define PRG_NAME			"NEC Powerø"		
#define ICON_INFO			0x4000					/* Farbe 4, kein Buchstabe	*/
#define ICON_NAME			"NEC P20/30"
#define VERSION			0x100						/* Version 1.00				*/
#define CPX_ID				"NECP"					/* NUR 4 Zeichen				*/
#define SOURCE				"NECPOWER.PRG"
#define DESTINATION		"E:\\SPRACHEN\\TEST_CPX\\NECPOWER.CPX"
...
LONG data[24]={
0x0L, 0x0L,
0x07FFFFF8L, 0x04000008L, 
0x05BFFC68L, 0x04000008L, 
0x05FFF7E8L, 0x04000008L, 
0x058FF1E8L, 0x04000008L, 
0x04000008L, 0x0FFFFFFCL, 
0x1FFFFFFEL, 0x10000002L, 
0x724624F2L, 0x72893482L, 
0x73092CE2L, 0x72892482L, 
0x12462482L, 0x10000002L, 
0x1FFFFFFEL, 0x0L,
0x0L,        0x0L,
					};
...
void main( void )
{
	...
	/* Image-Daten		*/
	for(i=0; i<24; i++)	header.icon_data[i]=data[i];

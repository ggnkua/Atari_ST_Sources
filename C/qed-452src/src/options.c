...
bool	save_opt, overwrite, blinking_cursor, ctrl_mark_mode;
PATH	helpprog;
...
void set_local_options(void)
{
	...
	if (active_local_option < 2)
		...
		strcpy(str, " *.");
	strcat(str, local_options[active_local_option].muster);

...
char	file_buffer[32768], path[] = "A:\*.FNT\0", file_name[] = "        .FNT\0",
		alert0[] = "[3][      FONTLOAD Ver. 1.0 |       J. Gardner 1985 | | Place Font Disk in Drive A: ][ Read Disk ]",
		alert1[] = "[3][      FONTLOAD Ver. 1.0 |      Font Load Complete | |      System Configured ][ Exit ]",
		alert2[] = "[3][      FONTLOAD Ver. 1.0 |     Font Load Cancelled | |    System Not Configured ][ Exit ]";
...
open_window()
{
	wi_handle = wind_create(NAME, (xdesk + wdesk) / 4, (ydesk + hdesk) / 4,
								   wdesk / 2, hdesk / 2);
	wind_set(wi_handle, WF_NAME, " FONTLOAD Ver. 1.0 ", 0, 0);

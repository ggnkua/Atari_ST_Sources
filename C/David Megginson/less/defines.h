 ...
 * DPM: added support for Gnu REGEXP library
 */
#define	REGCMP		0
#define	RECOMP		0
#define REGEXP		1
 ...
 */
#define	EDITOR		1
#define	EDIT_PGM	(getenv("EDITOR")?getenv("EDITOR"):"/bin/vi")
...
/*
 * FOR THE ATARI ST: SKIPCR causes all \r to be translated to blank
 * spaces.
 */
#define SKIPCR		1

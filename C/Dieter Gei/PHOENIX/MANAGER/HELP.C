 ...
 * Last modification: 19.06.02
 *
 *
 * Description: This module implements the help engine.
 *
 * History:
 * 19.06.02: In open_dbhelp Debug-Ausgabe hinzugefgt
...

{
  ...
  if (bShowDebugInfo)
  {
    sprintf (str, "[0][Hilfe-Datenbank-Ausgabe||DB: %s|DB-Pfad: %s|akt. Pfad: %s][~OK][0|1|1|0][]",
                   basename, basepath, act_path);
    open_alert ( str );
  } /* if */

 ...
 *
 * History:
 * 05.08.05: set_fonttable use vqt_ext_name if NVDI >=3.00 present
 * 04.12.02: Dxreaddir und Dxreadlabel ausgeklammert, da in der neuen Lib

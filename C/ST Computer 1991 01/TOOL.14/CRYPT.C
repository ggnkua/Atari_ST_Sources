 ...
 * Aufgabe      :
 *
 * Darstellung von SchlÅssel- und Datenobjekten
 ...
 * Datenblocks der LÑnge <n> mit den durch <t>
 ...
 * Aufgabe      :
 *
 * Zentrale VerschlÅsselungsroutine.
 */
 ...
 * Aufgabe      :
 *
 * Die VerschlÅsselung von Paûwîrtern mit dem
 * DES. Als erster Parameter wird das Paûwort
 * Åbergeben. Als zweiter Parameter ein mindestens
 * zwei Zeichen umfassender Zufallsstring.
 * Als Ergebnis erhÑlt man das verschlÅsselte 
 * Paûwort, dem die ersten beiden Zeichen des

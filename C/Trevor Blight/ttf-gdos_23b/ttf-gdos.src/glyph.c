...
*
*  $Id: glyph.c 3277 2021-08-29 16:45:08Z trevor $
*
*
...
*********************************************************************
*
* parse ttf glyph data and create a gem bitmap or font header info
*
...
SCAN_HDR *pp0 = pd->wks_fonts.scratch_adr;
   ...
   point_Rec * const glyf_point0 = malloc( (pg->maxp.maxPoints+3)*sizeof(point_Rec) );
	 ...
	 uint32     offset = *poffset;
         uint32  const glyf_size = poffset[1] - offset;	/* does this exist? <<< */

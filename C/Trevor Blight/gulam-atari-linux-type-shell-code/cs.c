...
# define P_(s) ()
#endif
local stpush P_((int op, uchar *f));
local STE *stpop P_((void));
local void stfree P_((void));
local uchar *atom P_((uchar *p));
local uchar *arithexp P_((uchar *p, uchar **nextword));
local uchar *relaexp P_((uchar *p, uchar *op, uchar **nextword));
local uchar *andor P_((uchar *p, uchar *op, uchar **nextword));
#undef P_

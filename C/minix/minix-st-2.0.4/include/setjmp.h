...
#include <ansi.h>
	...
	!defined(__SOZOBONX__) && !defined(__CC68__)
#define __ACK__
#endif
...
#endif
#endif
#if defined(__SOZOBONX__) || defined(__CC68__)
#define _SETJMP_SYMBOL 1
#undef _SETJMP_SAVES_REGS
#define _SETJMP_SAVES_REGS 1
#endif
 ...
 *	struct sigregs __regs;
 */
#ifdef __m68000		/*  do not include <minix/config.h> (CHIP == M68000) */
  void *__regs[18];		/* size is machine dependent */
#else
  void *__regs[16];		/* size is machine dependent */
#endif /* CHIP == M68000 */
#endif /* _SETJMP_SAVES_REGS == 0 */
} jmp_buf[1];

...
#define CHUNK	(8192 * sizeof(char *) - 1024)
#else
...
#if __SOZOBONX__
    /* bad hack for hcc, which doesn't like offsetof() */
    /*len += (size_t) ((char *)&dlink.file[0] - (char *)&dlink.dev) + 1;*/
    len += offsetof(dlink_t, file[0]) + 1;
#else

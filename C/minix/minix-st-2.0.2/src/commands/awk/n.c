...
node0(type)
{
  ...
  p = (NODE *) emalloc((unsigned int)(sizeof(*p) - sizeof(p)));
  p->n_type = type;
  p->n_next = NULL;
  return p;
}
...
node1(type, arg0) NODE *arg0;
{
  ...
  p = (NODE *) emalloc((unsigned int)sizeof(*p));
  p->n_type = type;
  p->n_next = NULL;
  p->n_arg[0] = (NODE *) arg0;
  return p;
...
node2(type, arg0, arg1) NODE *arg0, *arg1;
{
  ...
  p = (NODE *) emalloc((unsigned int) (sizeof(*p) + sizeof(p) * 1));
  p->n_type = type;
  p->n_next = NULL;
  p->n_arg[0] = (NODE *) arg0;
  p->n_arg[1] = (NODE *) arg1;
...
node3(type, arg0, arg1, arg2) NODE *arg0, *arg1, *arg2;
{
  ...
  p = (NODE *) emalloc((unsigned int) (sizeof(*p) + sizeof(p) * 2));
  p->n_type = type;
  p->n_next = NULL;
  p->n_arg[0] = (NODE *) arg0;
  p->n_arg[1] = (NODE *) arg1;
...
node4(type, arg0, arg1, arg2, arg3) NODE *arg0, *arg1, *arg2, *arg3;
{
  ...
  p = (NODE *) emalloc((unsigned int) (sizeof(*p) + sizeof(p) * 3));
  p->n_type = type;
  p->n_next = NULL;
  p->n_arg[0] = (NODE *) arg0;
  p->n_arg[1] = (NODE *) arg1;
...
mkcell(type, sval, fval) char *sval; double fval;
{
  ...
  p = (CELL *) emalloc((unsigned int) sizeof(*p));
  p->c_type = type;
  if (sval == NULL)
	p->c_sval = NULL;
  else

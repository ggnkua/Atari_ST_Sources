...
_PROTOTYPE(int compare, (const void *p1, const void *p2));
...
int compare(tmp_p1, tmp_p2)
_CONST void	*tmp_p1, *tmp_p2;
{
	struct outname	*p1 = (struct outname *)tmp_p1;
	struct outname	*p2 = (struct outname *)tmp_p2;
	int	i;

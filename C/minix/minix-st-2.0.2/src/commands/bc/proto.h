...
_PROTOTYPE(void assign, (/*char*/ int c_code));
...
_PROTOTYPE(void out_char, (/*char*/int ch));
...
_PROTOTYPE(void addbyte, (/*char*/ int byte));
...
_PROTOTYPE(void clear_func, (/*char*/ int func ));
...
_PROTOTYPE(void decr_array, (/*char*/ int var_name ));

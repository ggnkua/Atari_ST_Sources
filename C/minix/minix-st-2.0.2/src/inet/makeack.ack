...
# Fuer NDEBUG = "nicht definiert" wird der CPP vom GNU compiler gebraucht,
# siehe generic/assert.h.
# Programs, flags, and libraries
CC =		cc
CPPFLAGS =	-I. -I.. -I$i -I../$i -DNDEBUG=1
# Debugversion, DEBUG setzt bitweise printf-Flags
#CPPFLAGS =	-I. -I.. -I$i -I../$i -DTCP_DEF_MSS=296 -DNDEBUG=1 -DDEBUG=0xff
OPT	=	-O
CFLAGS =	$(OPT) $(CPPFLAGS)
C1FLAGS =	$(OPT) $(CPPFLAGS)
LDFLAGS =
HEAD = $l/../head.o
#HEAD = $l/crtso.o
...
inet:	$(HEAD) inet.a putk.o inetstack.o version.o $(LIBS)
#	$(CC) -o $@ $(LDFLAGS) inet.a putk.o version.o $(LIBS)
	/usr/lib/ld -c -o $@.tmp  $(HEAD) \
		putk.o version.o inet.a $(LIBS)
	@/usr/lib/cv $@.tmp $@
	@rm -f $@.tmp
	install -S 4k $@
...
clean:
	rm -f $(OBJ) inet.a inetstack.o putk.o version.o *.bak .all
...
inet_config.o:	$g/buf.h
inet_config.o:	$g/eth.h
inet_config.o:	$g/event.h
inet_config.o:	$g/ip.h
inet_config.o:	$g/ip_int.h
inet_config.o:	$g/psip.h
inet_config.o:	$g/sr.h
inet_config.o:	$g/type.h

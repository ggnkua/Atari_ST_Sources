 ...
 */
  ...
  fastload(IMAGE_DEV, (char *) m1.POSITION);	/* assumes 32 bit pointers */
#else
#if 1
  /* get number of used blocks */
  lcount = lastused(IMAGE_DEV);
  printf("Loading RAM disk. To load: %4DK        Loaded:   0K %c",
	((long)lcount * BLOCK_SIZE) / 1024, 0);
#else
...
/*  for (dummy=0; dummy<2000000; dummy++) ;*/
/*  return IMAGE_DEV; */

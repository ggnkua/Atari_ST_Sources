...
#ifdef __ACK__
	.define	EXIT
	.define	.trpim		! trap mask
	.define	.trppc
	.define	.lino		! current line number
	.define	.filn		! current file number
...
2:
	...
	jsr	__m_a_i_n	! run Pascal program
	add.w	#10,sp
3:
#ifdef __ACK__
EXIT:

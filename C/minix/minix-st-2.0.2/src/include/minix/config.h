...
#  define NR_BUF_HASH	512	/* size of buf hash table; MUST BE POWER OF 2*/
# else
#  define NR_BUFS	256	/* # blocks in the buffer cache (<=1536) */
...
#define DMA_SECTORS       32 	/* DMA buffer size (must be >= 1) */
...
/* Include code for symlinks */
#define	SYMLINKS	   1	/* enable symlinks */
...
#define MSTE		   3	/* Mega STe's */
#define TT		   4	/* TT */
#define	DETECT_TYPE	   5
...
/* Fixed Memory size in MByte */
#define	FIXED_MEM_SIZE	   0

/* Fixed CPU type, no autodetection */
/* CPU: 0 = 68000/68008, 1 = 68010, 2 = 68020, 3 = 68030, 4 = 68040 */
/* MMU: 0 = none, 1 = 68851, 3 = 68030 */
/* FPU: 0 = none, 1 = 68881, 2 = 68882 */
/*#define	FIXED_CPU	   0*/
/*#define	MMU_TYP		   0*/

/* Test for and activate H&N Multiboard (0 or 1) */
#define	MULTIBOARD	   1
#define	FULL_MULTIBOARD_TEST 0

/* Switch proc clock by PA_PD_DENS (0 or 1) */
#define	SPEEDUP16	   1
...
/* Use C interrupt handlers in rs232? */
#define	C_RS232_INT_HANDLERS	0

/* Automatically reboot after a kernel panic */
#define	REBOOT_AFTER_PANIC	1
...
/* make layout of struct sigframe compatible to Minix 1.6.x */
...
#define ENABLE_WINI	  (NR_ACSI_DRIVES!=0)
#define ENABLE_SCSI	  0
#define ENABLE_CDROM	  0
#define ENABLE_AUDIO	  0
#define ENABLE_DOSDSK	  0
#endif

...
/* prototype */
int32 Fcm_make_sprite_transparent( s_tga_ldg *image_tga, /*int16 pixel_xformat,*/ SURFACE *surface, SURFACE *surface_mask, MFDB *mfdb, MFDB *mfdb_mask, char *fichier, int16 x, int16 y );

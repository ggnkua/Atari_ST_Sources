...
rem Batch pour compiler le source de Badgers sous CygWin
rem MaJ 23/03/2026
...
rem .../dev/badgers.bat                 compilation de badgers
rem .../dev/badgers_build.bat           construction archives badgers
...
set NomProjet=Badgers
set ProjetSRC=badgers.c
set dossier_source=badgers
set dossier_executable=../EXEcutable/EXE_badgers/
set option_compilation=-O2 -fomit-frame-pointer -Wall -W -Wunused -Wshadow -Wpointer-arith -Wcast-qual -Wcast-align -Wstrict-prototypes -Wsign-conversion -s
...
set dossier_hatari=/cygdrive/H/Hatari_Disk/Daroou_HD_C/Daroou/badgers/badgers.DEV/
set dossier_aranym=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/badgers/badgers.dev/

set dossier_projet_rsc=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/badgers/
...
set dossier_hatari=/cygdrive/e/Hatari_Disk/Daroou_HD_C/Daroou/badgers/badgers.DEV/
set dossier_aranym=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/badgers/badgers.dev/

set dossier_projet_rsc=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/badgers/

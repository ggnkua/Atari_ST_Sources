...
void build_screen_badgers_mono( void );
...
void build_screen_badgers_mono( void )
{
	...
	if( build_screen_restart==TRUE )
	{
		...
		vrt_cpyfm(global_vdihandle_framebuffer, VRT_COPY_MODE, pxy_screen, &mfdb_prairie, &mfdb_framebuffer, couleur_vrt_copy );
...
//				vro_cpyfm(global_vdihandle_framebuffer,3,pxy_fond_badgers, &mfdb_prairie, &mfdb_framebuffer );
				vrt_cpyfm(global_vdihandle_framebuffer, VRT_COPY_MODE, pxy_fond_badgers, &mfdb_prairie, &mfdb_framebuffer, couleur_vrt_copy );
...
//					vro_cpyfm(global_vdihandle_framebuffer,7,pxy_badgers[idx_badgers], &mfdb_badgers[7][id_sprite_badger], &mfdb_framebuffer );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_MASQUE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers_mask[7][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_SPRITE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers[7][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );
...
//					vro_cpyfm(global_vdihandle_framebuffer,7,pxy_badgers[idx_badgers], &mfdb_badgers[9][id_sprite_badger], &mfdb_framebuffer );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_MASQUE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers_mask[9][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_SPRITE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers[9][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );
...
//					vro_cpyfm(global_vdihandle_framebuffer,7,pxy_badgers[idx_badgers], &mfdb_badgers[idx_badgers][id_sprite_badger], &mfdb_framebuffer );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_MASQUE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers_mask[idx_badgers][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );
					vrt_cpyfm(global_vdihandle_framebuffer,VRT_SPRITE_MODE,pxy_badgers[idx_badgers], &mfdb_badgers[idx_badgers][id_sprite_badger], &mfdb_framebuffer, couleur_mask_vrt );

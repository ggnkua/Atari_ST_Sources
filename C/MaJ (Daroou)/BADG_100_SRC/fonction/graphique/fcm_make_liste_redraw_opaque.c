...
/*	sprintf( texte, "OLD : %3d, %3d, %3d, %3d      ",  xywh_old->g_x, xywh_old->g_y, xywh_old->g_w, xywh_old->g_h );
	...
	sprintf( texte, "ECR : %3d, %3d, %3d, %3d      ",  Fcm_make_liste_redraw_xywh_ecran.g_x, Fcm_make_liste_redraw_xywh_ecran.g_y, Fcm_make_liste_redraw_xywh_ecran.g_w, Fcm_make_liste_redraw_xywh_ecran.g_h );

...
/* * 09/04/2003 MaJ 13/07/2017      * */
/* ********************************** */


#ifndef ___FCM_FORMATE_CHEMINFICHIER_C___
#define ___FCM_FORMATE_CHEMINFICHIER_C___


/* Prototype */
void Fcm_formate_cheminfichier( char *chemin, uint16 taille );
...
/*	sprintf(texte,"Chemin: {%s} ", chemin );
	...
	if( strlen(chemin)>taille && taille>9 )
	{
		...
		else
		{
			...
			/* 5 => '\...\' */
			} while( ((strlen(chemin)-(uint32)(pt_char2-pt_char1-5)) > taille) && pt_char1>chemin);
...
#endif  /* ___FCM_FORMATE_CHEMINFICHIER_C___ */

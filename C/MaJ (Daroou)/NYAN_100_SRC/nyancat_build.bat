...
rem Batch pour construire les archives de Nyancat sous CygWin
rem 14/03/2026
...
set nom_appli=NYANCAT
set appli_prefix=NYAN_
set version=100
set ObjetSrc2zip=nyancat fonction nyancat.bat nyancat_build.bat executable/exe_nyancat/exe_nyancat.txt build/nyancat/build.txt
set EXE_binaire=EXEcutable/EXE_nyancat

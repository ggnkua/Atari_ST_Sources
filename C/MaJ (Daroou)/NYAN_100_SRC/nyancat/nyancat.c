...
int main( void )
{
	...
	if( init == TRUE )
	{
		...
		/* voir init_nyancat() -> gestion appel init_surface()      */
		...
		/* Permet de redemmarer si une erreur arrive dans init_nyancat() */
		...
		do
		{
				...
				/* liberation RAM / Surface / Audio / etc... */
				exit_nyancat();

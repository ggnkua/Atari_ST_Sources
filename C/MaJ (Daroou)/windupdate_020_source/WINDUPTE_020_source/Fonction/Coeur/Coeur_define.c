...
#define COEUR_VERSION	"3.02"


/* -- Define pour la gestion fenetre -- */
#define FCM_NO_MY_WINDOW	NB_FENETRE
...
#define FCM_NO_OBJET_FIND		(-1)	/* no objet width objc_find() */
...
/*#define BT_PAUSE_DOWN		(100)
#define BT_PAUSE_UP			( 50)*/

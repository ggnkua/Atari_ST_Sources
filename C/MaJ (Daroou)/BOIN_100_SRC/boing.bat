...
rem Batch pour compiler le source de Boing sous CygWin
rem MaJ 14/03/2026



rem .../dev/boing/                    boing source
rem .../dev/fonction/                 core fonction source
rem .../dev/Build/xxxxx/              dossier des build
rem .../dev/EXEcutable/EXE_xxxx/      dossier des executables
rem .../dev/boing.bat                 compilation de boing
rem .../dev/boing_build.bat           construction archives boing
...
set NomProjet=Boing
set ProjetSRC=boing.c
set dossier_source=boing
set dossier_executable=../EXEcutable/EXE_boing/
...
set dossier_hatari=/cygdrive/H/Hatari_Disk/Daroou_HD_C/Daroou/boing/boing.DEV/
set dossier_aranym=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/boing/boing.dev/

set dossier_projet_rsc=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/boing/
...
set dossier_hatari=/cygdrive/e/Hatari_Disk/Daroou_HD_C/Daroou/boing/boing.DEV/
set dossier_aranym=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/boing/boing.dev/

set dossier_projet_rsc=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/boing/

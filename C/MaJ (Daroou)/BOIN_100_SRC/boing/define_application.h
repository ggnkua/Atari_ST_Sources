...
#define	PRG_FULL_NOM	"Boing" /*The bouncing Ball"*/
#define	PRG_TITRE_INFO	PRG_FULL_NOM

#define	PRG_NOM			"BOING"
#define	RSC_NOM			PRG_NOM".RSC"
#define	INF_NOM			PRG_NOM".INF"

#define	APP_WIN_PREFIX_TITRE "Boing"
...
#define	W_BOING				    (FCM_W_INDEX_APP_START+0) /*3*/
#define	W_OPTIONS				(FCM_W_INDEX_APP_START+1) /*4*/
#define	W_RAM					(FCM_W_INDEX_APP_START+2) /*5*/

#define NB_FENETRE				(FCM_W_INDEX_APP_START+3) /*6*/

...
#ifndef ___Fcm_transfert_image_to_mfdb___
#define ___Fcm_transfert_image_to_mfdb___



/* prototypes */
void Fcm_transfert_image_to_mfdb( s_tga_ldg *image, MFDB* mfdb  );
...
void Fcm_transfert_image_to_mfdb( s_tga_ldg *image, MFDB* mfdb  )
{
	...
	#ifdef LOG_FILE
	sprintf( buf_log, "Fcm_transfert_image_to_mfdb(%p, %p)"CRLF, image, mfdb );
	log_print(FALSE);
	#endif
...
#endif /* ___Fcm_transfert_image_to_mfdb___ */

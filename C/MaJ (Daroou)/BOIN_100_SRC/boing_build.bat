...
rem Batch pour construire les archives de Boing sous CygWin
rem MaJ 14/03/2026

rem ATTENTION !!! ATTENTION !!! ATTENTION !!! ATTENTION !!! 
rem commandes 'rm' dans ce batch sans confirmation
rem ATTENTION !!! ATTENTION !!! ATTENTION !!! ATTENTION !!! 
...
set nom_appli=BOING
set appli_prefix=BOIN_
set version=100
set ObjetSrc2zip=boing fonction boing.bat boing_build.bat executable/exe_boing/exe_boing.txt build/boing/build.txt
set EXE_binaire=EXEcutable/EXE_boing

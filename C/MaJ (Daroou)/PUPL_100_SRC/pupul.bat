...
rem Batch pour compiler le source de Pupul sous CygWin
rem MaJ 14/03/2026
...
rem .../dev/pupul.bat                 compilation de pupul
rem .../dev/pupul_build.bat           construction archives pupul
...
set NomProjet=Pupul Equinox GEM
set ProjetSRC=pupul.c
set dossier_source=pupul
set dossier_executable=../EXEcutable/EXE_pupul/
...
set dossier_hatari=/cygdrive/H/Hatari_Disk/Daroou_HD_C/Daroou/pupul/PUPUL.DEV/
set dossier_aranym=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/pupul/pupul.dev/

set dossier_projet_rsc=/cygdrive/H/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/pupul/
...
set dossier_hatari=/cygdrive/e/Hatari_Disk/Daroou_HD_C/Daroou/PUPUL/PUPUL.DEV/
set dossier_aranym=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/Pupul/pupul.dev/

set dossier_projet_rsc=/cygdrive/e/MyAES_Aranym_demo/diskC/applis/Daroou/rsc_prj/pupul/

...
rem Batch pour construire les archives de Pupul sous CygWin
rem MaJ 14/03/2026
...
set nom_appli=PUPUL
set appli_prefix=PUPL_
set version=100
set ObjetSrc2zip=pupul fonction pupul.bat pupul_build.bat executable/exe_pupul/exe_pupul.txt build/pupul/build.txt
set EXE_binaire=EXEcutable/EXE_pupul
...
set dossier_MOD_LDG=%home_dev%\EXEcutable\EXE_MOD_LDG\GRIFF\
...
cp -R   %dossier_MOD_LDG%/MOD.LDG                     %projet%/%dossier%/ > CONout.txt

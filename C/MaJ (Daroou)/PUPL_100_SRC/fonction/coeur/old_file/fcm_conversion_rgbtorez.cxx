...
/* Prototype */
uint32 Fcm_conversion_RGBtoRez( uint32 couleur );
...
{
/*
 * extern	uint16	screen_pixel_xformat;
 *
 */

	uint16	rouge,vert,bleu;
	...
	switch( screen_pixel_xformat )
	{
		case PIXEL_15_FALCON:
			...
			rouge=(uint16)( (float)( (couleur>>16)& 0xFF )*0.125 );
			/* rouge contient maintenant 00000000000rrrrr */

			vert =(uint16)( (float)( (couleur>> 8)& 0xFF )*0.125 );
			/* vert contient maintenant  00000000000vvvvv */

			bleu =(uint16)( (float)(  couleur     & 0xFF )*0.125 );
		...
		case PIXEL_16_MOTOROLA:
			...
			vert =(uint16)( (float)( (couleur>> 8)& 0xFF )*0.250 );

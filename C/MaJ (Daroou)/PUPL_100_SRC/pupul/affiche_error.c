...
/*		case APPLI_ERROR_XBIOS_FALCON:
		...
		case APPLI_ERROR_OPEN_MOD_LDG:
			idx_alt_error=ALT_ERR_OPEN_MOD;
			break;
...
/*		case MAKE_SPRITE_ERROR_TGA_LOAD:
			idx_alt_error=ALT_ERR_TGALOAD;
			break;*/


/*		case MAKE_SPRITE_ERROR_CREATE_SURFACE:
			idx_alt_error=ALT_ERR_SURFACE;
			break;*/
...
*/
		...
		case APPLI_ERROR_CYBERNOID_NOT_FOUND:
			idx_alt_error=ALT_ERR_CYBERMOD;
			break;
		...
		case APPLI_ERROR_LDG_MOD_INIT:
			idx_alt_error=ALT_ERR_MODINIT;
			break;
		case APPLI_ERROR_MOD_PATH_OVER:
			idx_alt_error=ALT_ERR_MOD_PATH;
			break;
		case APPLI_ERROR_MOD_SIZE:
			idx_alt_error=ALT_ERR_MOD_SIZE;
			break;
		case APPLI_ERROR_RESERVE_RAM:
			idx_alt_error=ALT_ERR_RES_RAM;
			break;
		case APPLI_ERROR_LOAD_MOD:
			idx_alt_error=ALT_ERR_LOAD_MOD;
			break;

		case APPLI_ERROR_ANIMATION_SIZE:
			idx_alt_error=ALT_ERR_ANIMSIZE;
			break;
		case APPLI_ERROR_ANIMATION_RAM:
			idx_alt_error=ALT_ERR_ANIM_RAM;
			break;
		case APPLI_ERROR_ANIMATION_LOAD:

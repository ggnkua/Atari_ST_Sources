...
log_print(FALSE);
		...
		rgb_in[0]=1000; //(255*1000)/255;
		rgb_in[1]=1000; //(255*1000)/255;
		rgb_in[2]=1000; //(255*1000)/255;
		vs_color( vdihandle, 0, rgb_in );

		rgb_in[0]=0; //(0*1000)/255;
		rgb_in[1]=0; //(0*1000)/255;
		rgb_in[2]=0; //(0*1000)/255;
		vs_color( vdihandle, 1, rgb_in );


		rgb_in[0]=(49*1000)/255;
		rgb_in[1]=(0*1000)/255;
		rgb_in[2]=(0*1000)/255;
		vs_color( vdihandle, 2, rgb_in );

		rgb_in[0]=(33*1000)/255;
		rgb_in[1]=(49*1000)/255;
		rgb_in[2]=(41*1000)/255;
		vs_color( vdihandle, 3, rgb_in );


		rgb_in[0]=(99*1000)/255;
		rgb_in[1]=(0*1000)/255;
		rgb_in[2]=(0*1000)/255;
		...
		rgb_in[0]=(148*1000)/255;
		rgb_in[1]=(33*1000)/255;
		rgb_in[2]=(0*1000)/255;
		vs_color( vdihandle, 6, rgb_in );

		rgb_in[0]=(198*1000)/255;
		rgb_in[1]=(49*1000)/255;
		rgb_in[2]=(5*1000)/255;
		vs_color( vdihandle, 7, rgb_in );

		rgb_in[0]=(74*1000)/255;
		rgb_in[1]=(90*1000)/255;
		rgb_in[2]=(74*1000)/255;
		vs_color( vdihandle, 8, rgb_in );

		rgb_in[0]=(12*1000)/255;
		rgb_in[1]=(26*1000)/255;
		rgb_in[2]=(115*1000)/255;
		vs_color( vdihandle, 9, rgb_in );

		rgb_in[0]=(0*1000)/255;
		rgb_in[1]=(115*1000)/255;
		rgb_in[2]=(156*1000)/255;
		vs_color( vdihandle, 10, rgb_in );

		rgb_in[0]=(0*1000)/255;
		rgb_in[1]=(192*1000)/255;
		rgb_in[2]=(236*1000)/255;
		vs_color( vdihandle, 11, rgb_in );

		rgb_in[0]=(198*1000)/255;
		rgb_in[1]=(132*1000)/255;
		rgb_in[2]=(66*1000)/255;
		vs_color( vdihandle, 12, rgb_in );

		rgb_in[0]=(231*1000)/255;
		rgb_in[1]=(99*1000)/255;
		rgb_in[2]=(99*1000)/255;
		...
		rgb_in[0]=(164*1000)/255;
		rgb_in[1]=(164*1000)/255;
		rgb_in[2]=(164*1000)/255;

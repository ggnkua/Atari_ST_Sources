...
#define	PRG_FULL_NOM	"Equinox Pupul"
#define	PRG_TITRE_INFO	PRG_FULL_NOM

#define	PRG_NOM			"PUPUL"
#define	RSC_NOM			PRG_NOM ".RSC"
#define	INF_NOM			PRG_NOM ".INF"

#define	APP_WIN_PREFIX_TITRE "Pupul"
...
#define	W_PUPUL 				(FCM_W_INDEX_APP_START+0)
#define	W_OPTIONS				(FCM_W_INDEX_APP_START+1)
#define	W_MODLDG				(FCM_W_INDEX_APP_START+2)

#define NB_FENETRE				(FCM_W_INDEX_APP_START+3)

...
public:
	...
	int Handle() { return handle; } // ONLY USE THIS FOR INTERFACING TO C.
	...
	int NumberOfPredefinedColors() const			{ return WorkOut(13); }
	int NumberOfAvailableColors() const			{ return WorkOut(39); }
	...
	bool Color() const								{ return WorkOut(35); }
	...
	int NumberOfBackgroundColors() const			{ return ExtWorkOut(1); }

...
VOID draw_box_Area ( OBJECT *Objc, GRECT *Area )
{
  ...
  x0    = Objc->ob_x;
  y0    = Objc->ob_y;
  x1    = x0 + Objc->ob_width - 1;
  y1    = y0 + Objc->ob_height - 1;
      ...
      switch ( xevent.msg [0] )
        {
          ...
          case WM_ALLICONIFY    : if ( iconified () != NULL ) break;
                                  ...
                                  break;
          case VA_DRAGACCWIND   : if ( forced () != NULL ) break;
  ...
  switch ( par )
    {
      ...
      case PAR_AVSERVER  : return ( p->AVServer         );

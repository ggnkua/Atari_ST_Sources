...
int Next_Beaver()   
/* erzeugt nÑchsten Biber, gibt 1 zurÅck, wenn dieser existiert, sonst 0  */
{  register int index,zustand,ueber,next,mode;
   ...
   if (zustand<1) return(0);

   if((Beaver[0][1].zu_schreiben=='1')&&(Beaver[0][1].nae_position==1)&&
      (Beaver[0][1].nae_zustand=='1')) return(0);

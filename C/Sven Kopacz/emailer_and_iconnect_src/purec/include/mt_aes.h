...
extern WORD MT_wind_get_int( WORD whdl, WORD subfn, WORD * g2, WORD *global );
...
extern WORD MT_wind_set_int( WORD whdl, WORD subfn, WORD g1, WORD *global);

/* obstack.h - object stack macros
   ...
   $Id: obstack.h,v 1.7 91/10/23 16:47:32 pete Exp $
...

#if defined( GNUDOS ) || defined( __WATCOMC__ )
void obstack_free (struct obstack *obstack, char * block);
#endif

#if ! defined( __HIGHC__ ) && ! defined( GNUDOS ) && ! defined( _INTELC32_ ) && ! defined( __WATCOMC__ )
#ifdef __STDC__

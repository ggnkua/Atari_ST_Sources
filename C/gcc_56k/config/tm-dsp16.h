/* Definitions of target machine for GNU compiler, for the Motorola dsp561XX
   digital signal processing chip.
   Copyright (C) 1988 Free Software Foundation, Inc.

   $Header: /usr1/dsp/cvsroot/source/gcc/config/tm-dsp16.h,v 1.2 91/09/18 15:34:46 jeff Exp $
   $Id: tm-dsp16.h,v 1.2 91/09/18 15:34:46 jeff Exp $
...
#define CPP_PREDEFINES "-DDSP16"

/* Print subsidiary information on the compiler version in use.  */
#define TARGET_VERSION fprintf (stderr, " Motorola DSP561XX %s", \
...
/* number of bits in an addressible storage unit. has word addressing */
#define BITS_PER_UNIT 16
#define CHAR_TYPE_SIZE 16
#define SHORT_TYPE_SIZE 16
#define LONG_TYPE_SIZE 32
#define LONG_LONG_TYPE_SIZE LONG_TYPE_SIZE
#define FLOAT_TYPE_SIZE (( 'l' == memory_model ) ? 16 : 32 )
...
/*
  ...
  for the dsp16, we have X1,X0,Y1,Y0,A,B and R0-R3. N0-N3 remain unknown
...
/* 1 for registers that have pervasive standard uses
   ...
   9       = (r3) stack pointer.
*/
#define DSP16_A_REGNUM 0
#define DSP16_B_REGNUM 1
#define DSP16_X0_REGNUM 2
#define DSP16_X1_REGNUM 3
#define DSP16_Y0_REGNUM 4
#define DSP16_Y1_REGNUM 5
...
/* Return number of consecutive hard regs needed starting at reg REGNO
   ...
   dsp16 puts floats/doubles into 32 bit regs, longs into 32 bit regs. */

#define HARD_REGNO_NREGS( REGNO, MODE ) \
    ((( DFmode == MODE || SFmode == MODE || DImode == MODE ) && \
      ( REGNO != DSP16_A_REGNUM ) && ( REGNO != DSP16_B_REGNUM )) ? 2 : 1 )
...
#define STATIC_CHAIN_REGNUM DSP16_A_REGNUM

/* Register in which address to store a structure value
   is passed to a function.  */
#define STRUCT_VALUE_REGNUM DSP16_A_REGNUM
...
#define REG_CLASS_CONTENTS {			\
	...
	000000001700, /* ADDR_REGS */		\
	000000000024, /* MPY_REGS */		\
	000000000074, /* SRC_REGS */		\
	000000001777  /* ALL_REGS */	}
...
/* Define how to find the value returned by a function.
   ...
   otherwise, FUNC is 0.  */
#define LIBCALL_VALUE(MODE)  (gen_rtx ( REG, MODE, DSP16_A_REGNUM ))
...
#define FUNCTION_VALUE_REGNO_P(N) ( DSP16_A_REGNUM == ( N ))
...
#define REGNO_OK_FOR_BASE_P(REGNO)  				\
	(( 5 < REGNO && 10 > REGNO ) ||				\
	 ( 5 < reg_renumber[REGNO] && 10 > reg_renumber[REGNO]))
...
#define ASM_IDENTIFY_GCC(FILE) fprintf ( FILE, ";*** DSP561XX %s GNU %s\n", motorola_version_string, version_string );
...
#define ASM_OUTPUT_DOUBLE_INT(FILE,VALUE)				  \
    (( 'l' == memory_model ) ?						  \
     ...
     (( CONST_INT == GET_CODE( VALUE )) ?				  \
      ( fprintf ( FILE, "\tdc\t$%04x\n\tdc\t$%04x\n",			  \
		 ( INTVAL ( VALUE ) & 0xffff ),		  	          \
		 (( INTVAL ( VALUE ) >> 16 ) & 0xffff ))) :		  \
      ( fprintf ( FILE, "\tdc\t$%04x\n\tdc\t$%04x\n", 		 	  \
		 ( CONST_DOUBLE_LOW ( VALUE ) & 0xffff ),		  \
		 (( CONST_DOUBLE_LOW ( VALUE ) >> 16 ) & 0xffff )))))
...
/* this is a kludge. 
   the dsp16 uses accumulators a and b in weird ways. b can hold either
   a 32 bit or 16 bit value. if it holds a 32 bit value, there is no way
...
#define INSN_MACHINE_INFO dsp16_insn_info

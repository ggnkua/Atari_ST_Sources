/* Register Transfer Language (RTL) definitions for GNU C-Compiler
   ...
   $Id: rtl.h,v 1.13 91/11/22 19:44:32 pete Exp $
...
#if defined( DSP56000 )
#define GET_MODE_SIZE(MODE)		(PSImode==(MODE)?1:(mode_size[(int)(MODE)]/3))
#else
...
#if defined( DSP56000 )
#define GET_MODE_UNIT_SIZE(MODE)	(mode_unit_size[(int)(MODE)]/3)
#else
...
#if defined( DSP56000 )
#define GET_MODE_BITSIZE(MODE)  (BITS_PER_UNIT * mode_size[(int)(MODE)]/3)
#else
...
#endif /* _INTELC32_ || __WATCOMC__ */
#endif /* SHORT_ENUM_BUG */

#if defined ( __WATCOMC__ )
/*  it looks as though the fabulous CUM compiler dontdono bit fields */
...
#if defined( DSP56000 )
  /* 1 in a SUBREG created by emit_reload_insn, which contains no real meaning,
     but is used to alter the access mode. */
  unsigned int reload_subreg;
  /* 1 if the insn is an UNSIGNED compare. On the 56k, signed compares may use
     10 different register combinations, unsigned can use only one. */
  unsigned int unsigned_compare;
#endif  /* DSP56000 */
#if defined( DSP56000 ) || defined( DSP96000 )
  /* this is part of the kludge to fix the reload fiasco. 
     a new field is needed in order to tag addresses of 
     stack spill slots. */
  unsigned reload_generated;
  /* This MEM expression was generated as a reload stack slot. */
#define RTX_RELOAD_GENERATED_P(RTX) ((RTX)->reload_generated)
  ...
  /* 1 in a SUBREG created by emit_reload_insn, which contains no real meaning,
     but is used to alter the access mode. */
  unsigned int reload_subreg : 1;
  /* 1 if the insn is an UNSIGNED compare. On the 56k, signed compares may use
     10 different register combinations, unsigned can use only one. */
  unsigned int unsigned_compare : 1;
#endif  /* DSP56000 */
#if defined( DSP56000 ) || defined( DSP96000 )
  /* this is part of the kludge to fix the reload fiasco. 
     a new field is needed in order to tag addresses of 
     stack spill slots. */
  unsigned reload_generated : 1;
  /* This MEM expression was generated as a reload stack slot. */
#define RTX_RELOAD_GENERATED_P(RTX) ((RTX)->reload_generated)
#endif  /* DSP56000 || DSP96000 */
#endif  /* __WATCOMC__ */
...
#if defined( DSP56000 )
/* 1 if RTX is a meaning-free SUBREG created by emit_reload_insns ( ) */
#define RELOAD_SUBREG_P(RTX) ((RTX)->reload_subreg)
/* 1 if INSN is an unsigned compare */
#define UNSIGNED_COMPARE_P(INSN) ((INSN)->unsigned_compare)
#endif
...
#endif
#if defined( DSP96000 )
/* ugliness due to deficient MetaWare C Compiler. */
extern rtx local_fuction_incoming_arg ( );
#endif
extern rtx copy_rtx ();
#if defined( STDARGS_ARE_COOL )

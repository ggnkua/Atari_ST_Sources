/* Dummy data flow analysis for GNU compiler in nonoptimizing mode.
   ...
   $Id: stupid.c,v 1.3 91/10/10 14:47:00 jeff Exp $
...
#if defined( DSP56000 ) || defined( DSP96000 ) || defined( DSP56100 )
  /* we want to take into account the insn in which the register dies, 
     because it might be a destination in that insn. (such as a CLOBBER). */

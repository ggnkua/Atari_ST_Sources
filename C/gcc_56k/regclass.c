/* Compute register class preferences for pseudo-registers.
   ...
   $Id: regclass.c,v 1.5 91/10/23 16:50:18 pete Exp $
...
init_reg_sets ()
{
  ...
  for ( i = 0; i < N_REG_CLASSES; ++ i )
  {
      reg_class_superclasses[DI_REGS][i] = LIM_REG_CLASSES;
      reg_class_superclasses[FP_REGS][i] = LIM_REG_CLASSES;
      reg_class_subclasses[DI_REGS][i] = LIM_REG_CLASSES;
      reg_class_subclasses[FP_REGS][i] = LIM_REG_CLASSES;
      reg_class_subunion[DI_REGS][i] = NO_REGS;
      reg_class_subunion[FP_REGS][i] = NO_REGS;
  }
#endif

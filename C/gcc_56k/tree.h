/* Front-end tree definitions for GNU compiler.
   ...
   $Id: tree.h,v 1.9 91/12/19 14:18:38 jeff Exp $
...
/* see explanation in struct tree_decl */
#define DECL_X_LOAD(NODE) ((NODE)->decl.x_load)
#define DECL_X_RUN(NODE) ((NODE)->decl.x_run)
#define DECL_Y_LOAD(NODE) ((NODE)->decl.y_load)
#define DECL_Y_RUN(NODE) ((NODE)->decl.y_run)
#define DECL_L_LOAD(NODE) ((NODE)->decl.l_load)
#define DECL_L_RUN(NODE) ((NODE)->decl.l_run)
#define DECL_P_LOAD(NODE) ((NODE)->decl.p_load)
#define DECL_P_RUN(NODE) ((NODE)->decl.p_run)
#endif
...
#if defined( DSP56000 ) || defined( DSP96000 )
  /* these are used to support the #pragmas that change org directives.
     this extension allows objects such as global and static inline 
     compilation to be deferred. */
  char *x_load, *x_run, *y_load, *y_run, *l_load, *l_run, *p_load, *p_run;
#endif
};

...
/* The type node for the double type.  */
extern tree double_type_node;

/* The type node for the unsigned character type.  */
extern tree unsigned_char_type_node;

/* The type node for the unsigned long type. */

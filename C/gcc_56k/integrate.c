/* Procedure integration for GNU CC.
   ...
   $Id: integrate.c,v 1.4 91/08/06 09:59:50 jeff Exp $
	  ...
	  if (GET_CODE (copy) == CONST_INT)
	    {
	      ...
	      /* we must reverse the mode of comparison here when
		 the stack grows upward: the address of the first
		 parameter is < the address of all local variables. */

...
typedef struct drv_list {
    ...
    DRV_HDR * __stdargs (*get_dftab) (char *);  /* Get Driver Function Table    */
    int16     __stdargs (*ETM_exec) (char *);   /* Execute a STinG module       */
...
typedef  struct tpl  {
    ...
    char *       (* get_err_text) (int16);
    char *       (* getvstr) (char *);
    int16        (* carrier_detect) (void);
    int16        (* TCP_open) (uint32, int16, int16, uint16);
    ...
    int16        (* UDP_open) (uint32, int16);
    int16        (* UDP_close) (int16);
    int16        (* UDP_send) (int16, void *, int16);
    int16        (* CNkick) (int16);
    int16        (* CNbyte_count) (int16);
    int16        (* CNget_char) (int16);
    NDB *        (* CNget_NDB) (int16);
    int16        (* CNget_block) (int16, void *, int16);
    void         (* housekeep) (void);
    int16        (* resolve) (char *, char **, uint32 *, int16);
    void         (* ser_disable) (void);
    void         (* ser_enable) (void);
    int16        (* set_flag) (int16);
    void         (* clear_flag) (int16);
    CIB *        (* CNgetinfo) (int16);
    int16        (* on_port) (char *);
    void         (* off_port) (char *);
    int16        (* setvstr) (char *, char *);
    int16        (* query_port) (char *);
    int16        (* CNgets) (int16, char *, int16, char);

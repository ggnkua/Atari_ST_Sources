...
{
  -1,  1, 21, G_BOX,    NONE,   OUTLINED, (long)0x00021100L,0x0000, 0x0000, 0x0021, 0x0017,
   2, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0001, 0x0001, 0x0001,
   3, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0002, 0x0001, 0x0001,
   4, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0003, 0x0001, 0x0001,
   5, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0004, 0x0001, 0x0001,
   6, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0005, 0x0001, 0x0001,
   7, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0006, 0x0001, 0x0001,
   8, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0007, 0x0001, 0x0001,
   9, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0008, 0x0001, 0x0001,
  10, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0009, 0x0001, 0x0001,
  11, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000A, 0x0001, 0x0001,
  12, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000B, 0x0001, 0x0001,
  13, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000C, 0x0001, 0x0001,
  14, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000D, 0x0001, 0x0001,
  15, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000E, 0x0001, 0x0001,
  16, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x000F, 0x0001, 0x0001,
  17, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0010, 0x0001, 0x0001,
  18, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0011, 0x0001, 0x0001,
  19, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0012, 0x0001, 0x0001,
  20, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0013, 0x0001, 0x0001,
  21, -1, -1, G_STRING, NONE,   NORMAL,   (long)0L,         0x0001, 0x0014, 0x0001, 0x0001,
   0, 22, 26, G_IBOX,   NONE,   NORMAL,   (long)0x00001100L,0x0001, 0x0015, 0x0001, 0x0001,
  23, -1, -1, G_BUTTON, 0x0005, NORMAL,   (long)0L,         0x0000, 0x0000, 0x0001, 0x0001,
  24, -1, -1, G_BUTTON, 0x0005, NORMAL,   (long)0L,         0x0000, 0x0000, 0x0001, 0x0001,
  25, -1, -1, G_BUTTON, 0x0005, NORMAL,   (long)0L,         0x0000, 0x0000, 0x0001, 0x0001,
  26, -1, -1, G_BUTTON, 0x0005, NORMAL,   (long)0L,         0x0000, 0x0000, 0x0001, 0x0001,
  21, -1, -1, G_BUTTON, 0x0025, NORMAL,   (long)0L,         0x0000, 0x0000, 0x0001, 0x0001
  };
...
static int count_strings( char **pstrings, int maxstrings, int *pmaxlen)
{
	int numstrings;
	int wrklen;
	int maxlen;
...

	{
			 ...
			 ++counter, ++ptree)
		{
			if (counter < numobs)
			{
				...
				ptree->ob_spec.free_string = line;
				ptree->ob_x 	 = at_x;
				ptree->ob_width  = len;

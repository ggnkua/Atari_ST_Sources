...
static OBJECT msgtree[] = {
    -1,  1,  1, G_BOX,  NONE,   SHADOWED, (long)0x00FF2100L, 0, 0, 0, 0,
     0,  2, 21, G_BOX,  NONE,   NORMAL,   (long)0x00000000L, 1, 0, 0, 0,
     3, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 0, 0, 1,
     4, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 1, 0, 1,
     5, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 2, 0, 1,
     6, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 3, 0, 1,
     7, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 4, 0, 1,
     8, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 5, 0, 1,
     9, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 6, 0, 1,
    10, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 7, 0, 1,
    11, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 8, 0, 1,
    12, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0, 9, 0, 1,
    13, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,10, 0, 1,
    14, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,11, 0, 1,
    15, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,12, 0, 1,
    16, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,13, 0, 1,
    17, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,14, 0, 1,
    18, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,15, 0, 1,
    19, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,16, 0, 1,
    20, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,17, 0, 1,
    21, -1, -1, G_TEXT, NONE,   NORMAL,   (long)0L,          0,18, 0, 1,
     1, -1, -1, G_TEXT, LASTOB, NORMAL,   (long)0L,          0,19, 0, 1,
};
...
static void treeplace(OBJECT *ptree, VRECT *vdirect)
{
	int wrkint1, wrkint2, wrkint3;
...
int frm_eflag(OBJECT *ptree, int obj, char *fmt, ...)
{
	...
	vs_clip(vdi_handle, TRUE, (int *)&gl_rfscrn);
	v_rbox(vdi_handle, (int *)&flagbox);   				   /* flag object */
	vs_clip(vdi_handle, FALSE, (int *)&gl_rfscrn);
	vsl_color(vdi_handle, 1);
	vsl_width(vdi_handle, 1);
	graf_mouse(M_ON, 0L);

	objc_draw(msgtree, R_TREE, MAX_DEPTH,
				msgrect.g_x,
				msgrect.g_y,
				msgrect.g_w,
				msgrect.g_h

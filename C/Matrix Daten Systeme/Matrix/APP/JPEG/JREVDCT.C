...
#define OCOS_5_16 OSIN_3_16
						...
						/*	hdg.jpg 			  summe		rev-dct	*/
						/* original :			11.9 sec	5.3		*/
# define USE_MACROS	0	/*						12.6 sec	6.0		*/
# define USE_2DCT	0	/*						11.6 sec	5.0		*/
						/*  + include <math.h>:	11.3 sec			*/
						/* dummy:				6.6 sec		---		*/

# if USE_MACROS
# define fast_idct_8(i,s)\
{\
  in = i ;\
  stride = s ;\
  in0 = in[       0];\
...
# elif	USE_2DCT	/*	hdg.jpg	: 11.2 sec	*/
INLINE
LOCAL void
fast_idct_88 (DCTELEM *in)
# define stride 8
{

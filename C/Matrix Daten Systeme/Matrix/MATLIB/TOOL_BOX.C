...
# define TOOLboxDescr struct TOOLboxStruct

typedef struct TOOLboxStruct
{
	TOOLboxDescr *list,			/* list chain		*/
				 *pred, *succ ;	/* sequence chain	*/
...
TOOLbox tool_box_list  = NULL ;
TOOLbox tool_box_shown = NULL ;

int start_box_y	;

# define select_box (&(tool_box_list->object))
# define tool_tree  (&(tool_box_list->tree))

...
/*--------------------------------------------------- clr_window ----*/
void clr_window(WINDOWdescr *wd)
{
# if 0
	wd->next		= NULL ;
	wd->back		= NULL ;
...
/*--------------------------------------------------- remove_window ----*/
void remove_window ( WINDOWdescr *window )
{
	RECTangle   curr;
...
/*------------------------------------------ remove_all_but ------*/
void remove_all_but(WINDOWdescr *window)
{
	WINDOWdescr *wd ;
...
# endif
		if ( handle >= 0 )
		{
			*window			= wd ;			/* first window in list	*/
			wd->next		= WindowTable ;
			WindowTable 	= wd ;

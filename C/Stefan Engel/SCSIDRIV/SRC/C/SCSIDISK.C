 ...
 *
 * $Source: u:\usr\src\scsi\cbhd\rcs\scsidisk.c,v $
 *
 * $Revision: 1.3 $
 *
...
tCmd6 Cmd;
  ...
  {
    SetCmd6(&Cmd, 0x08, BlockAdr, (UWORD)(MaxDmaLen / BlockLen));
...
tCmd10 Cmd;
  ...
  while (TransferLen > MaxDmaLen / BlockLen)
  {
    SetCmd10(&Cmd, 0x028, BlockAdr, (UWORD)(MaxDmaLen / BlockLen));
...
tCmd6 Cmd;
  ...
  while (TransferLen > MaxDmaLen / BlockLen)
  {
    SetCmd6(&Cmd, 0x0A, BlockAdr, (UWORD)(MaxDmaLen / BlockLen));
...
tCmd10 Cmd;
  ...
  while (TransferLen > MaxDmaLen / BlockLen)
  {
    SetCmd10(&Cmd, 0x02A, BlockAdr, (UWORD)(MaxDmaLen / BlockLen));
...
#define cMaxBlockAdr  0x001FFFFFL /* Max. Blocknummer bei Read6/Write6  */

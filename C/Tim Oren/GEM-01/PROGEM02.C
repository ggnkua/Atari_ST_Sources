06601030301800
1Tim Oren- Professional GEM -WINDOWS (Part II)
2Appendix A- PROGEM02.C -Page A#
F0110030
9[...............................................]001
€/************************* Sample Redraw Code *************************/
...
do_redraw(wh, area)                 /* wh = window handle from msg[3] */
   WORD  wh;                    /* area = pointer to redraw rectangle */
   GRECT *area;                 /*        in msg[4] thru msg[7]       */
   {
   GRECT box;
   ...
   while (box.g_w && box.g_h)
      ...
      if (rc_intersect(area, &box))
         ...
         if (wh == w1_handle)             /* Test for window 1 handle */
            {                                   /* AES redraw example */
            objc_draw(w1_tree, ROOT, MAX_DEPTH, box.g_x, box.g_y, 
                      box.g_w, box.g_h);
            }
...
set_clip(clip_flag, area)               /* set clip to specified area */
   ...
   VOID
grect_to_array(area, array)          /* convert x,y,w,h to upr lt x,y */
   GRECT *area;                      /*                and lwr rt x,y */
   WORD  *array;
   {
   *array++ = area->g_x;
   *array++ = area->g_y;
...
€/************************ Window full utility *************************/
   ...
   VOID
hndl_full(wh)  /* Depending on current window state, make window full */
   WORD  wh;   /* size or return to previous shrunken size; the graf_ */
   {           /* calls are optional special effects                  */
   GRECT prev;
   GRECT curr;
   GRECT full;
   ...
   if (rc_equal(&curr, &full))
      ...
      graf_shrinkbox(prev.g_x, prev.g_y, prev.g_w, prev.g_h, full.g_x,
      ...
      graf_growbox(curr.g_x, curr.g_y, curr.g_w, curr.g_h, full.g_x, 
                   full.g_y, full.g_w, full.g_h);

06601030301800
1Tim Oren- Professional GEM -INTERFACE POTPOURRI
2Appendix A- PROGEM16.C -Page A#
F0110030
9[...............................................]001
...
set_prog(value, maxc)
   ...
   if (value)
      ...
      objc_draw(tree, ROOT, MAX_DEPTH, box.g_x, 
...
fourway_box(vdi_handle, rubber, limit)
   ...
   graf_mkstate(&mx, &my, &foo, &foo);   /* Initialize mouse position */
   ...
   do {
      ...
      rc_intersect(limit, rubber);       /* Lock into limit rectangle */
...
hot_dragbox(vdi_handle, box, limit, tree)
   ...
   do {
      box->g_x = mx - ox;
      box->g_y = my - oy;
      rc_constrain(limit, box);          /* Lock into limit rectangle */

06601030301800
1Tim Oren- Professional GEM -RCS
2Appendix A- PROGEM04.C -Page A#
F0110030
9[...............................................]001
€/******************* Sample C output file from RCS * (Comments added) */
...
€ICONBLK rs_iconblk[] = {    /* First pointer is mask, second is data, */
1L, 2L, 10L, 4096, 0, 0, 0, 0, 48, 24, 9, 24, 30, 8,  /* third is to  */
3L, 4L, 17L, 4864, 0, 0, 0, 0, 48, 24, 0, 24, 48, 8}; /* title string */
...
OBJECT rs_object[] = {                            /* Pointers are to: */
-1, 1, 3, G_BOX, NONE, OUTLINED, 0x21100L, 0, 0, 18, 12, 
...
LONG rs_trindex[] = {        /* Points to start of trees in rs_object */
0L, 
5L, 
12L};

struct foobar {               /* Temporary structure used by RSCREATE */
   WORD  dummy;               /* when setting up image pointers       */
   WORD  *image;
   } rs_imdope[] = {
0, &IMAG0[0], 
0, &IMAG1[0], 
...
typedef struct text_edinfo
   ...
   long  te_pvalid;                        /* ptr to validation chars */
   int   te_font;                                             /* font */

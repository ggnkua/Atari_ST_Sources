...
<ENTRY>
	...
	<ARCHIVE>
		...
		<ITEM NAME="Chatter.app" PATH="Chatter.app">
		<ITEM NAME="ChatterIcon.rsc" PATH="ChatterIcon.rsc">
		<ITEM NAME="ReadMe.txt" PATH="ReadMe.txt">
		LINK=2
		SETS=1
		FCNT=4
		SIZE=266433
...
<ENTRY>
	...
	<ARCHIVE>
		...
		TEXT="ST-Guide-Hypertext installieren"
		FILE="data\Bubble.lzh"
		<ITEM NAME="Bubble.hyp" PATH="Bubble.hyp">
		<ITEM NAME="Bubble.ref" PATH="Bubble.ref">
		SETS=1
		FCNT=2
		SIZE=28678
	</ARCHIVE>

...
char *TX_ADVERT=		NAMETX" "VERSIONTX" by Andy Pennell";
char *TX_ADVERTDEBUG=	NAMETX" "VERSIONTX" DEBUG by Andy Pennell";
char *TX_AADVERT=		NAMETX" Resident "VERSIONTX" by Andy Pennell";
char *TX_COPYRIGHT=		"Copyright ½ 1992 Andy Pennell. All Rights Reserved\n";

...
LONG Read(ULONG BlockAdr,
             UWORD TransferLen, void *buffer);
  /*
   * ReadCmd liest Datenblöcke ein
   * Wenn nötig, wird ein langes Kommando (10 Byte, Class 1) verwendet.
   */

LONG Write(ULONG BlockAdr,
              UWORD TransferLen, void *buffer);
  /*
   * WriteCmd speichert Datenblöcke ab.
   * Wenn nötig, wird ein langes Kommando (10 Byte, Class 1) verwendet.
   */
...
/*-------------------------------------------------------------------------*/
/*-                                                                       -*/
/*- ReadCapacity fragt die Gröže des Laufwerkes ab.                       -*/
/*- Bei PMI = TRUE wird der nach BlockAdr nächste Block angegeben, der    -*/
/*- noch ohne Verzögerung übertragen werden kann.                         -*/
...
/*- Geschwindigkeitsänderung übertragen werden kann.                      -*/
/*- PMI=FALSE erfragt die absolute Gröže des Gerätes.                     -*/
/*- SCSI-Opcode $25                                                       -*/
/*-                                                                       -*/
/*-                                                                       -*/
/*-------------------------------------------------------------------------*/

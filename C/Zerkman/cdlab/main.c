...
/* #define SPREAD_VERSION       /* A absolument définir pour une version diffusable */

/* void audio_test( struct device_info * dev ); */
/* void tao_test( struct device_info * info ); */

char version_string[] = "CDLab v0.90ß";
...
/* Génération d'un popup de devices, en fonction d'un masque
...
/* Recentrage d'une fenêtre, avec possibilité de fournir
...
int main( void )
{
  ...
  /* Cette ligne semble poser problème sous N.AES */

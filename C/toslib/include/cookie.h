/*
 * $Id: cookie.h pdonze Exp $
 * 
 * TOS.LIB - (c) 1998 - 2006 Philipp Donze
 *
 * A replacement for PureC PCTOSLIB.LIB
 *
 * This file is part of TOS.LIB and contains:
 *    Cookie name definitions and handling function prototypes.
 *    The cookie name definitions has been copied from MiNTlib Project.
 *
...
/* Return values of Getcookie(), Setcookie and Removecookie():
	C_OK and C_FOUND  - successful operations.
	C_NOTFOUND        - actions on non-existing cookies
	C_JARNOTINSTALLED - no cookie jar installed (old TOS?)
	C_JARFULL         - no more space to store cookie in cookie jar.
 */
#define	C_OK				0
#define	C_FOUND				C_OK
#define	C_NOTFOUND			1
#define	C_JARNOTINSTALLED	2
#define	C_JARFULL			3

/* Look-up cookie value in cookie jar */
short Getcookie(long cookie, long *value);

/* Add/update cookie with given value to cookie jar */

...
#ifdef PASCAL
LOCAL   BYTE            sccs0 []        = "@(#) SysGem (c) 1995 by Andrea Pietsch / V2.03.3 / PurePascal ("__DATE__", "__TIME__")";
#else
LOCAL   BYTE            sccs0 []        = "@(#) SysGem (c) 1995 by Andrea Pietsch / V2.03.3 / PureC ("__DATE__", "__TIME__")";
#endif
LOCAL   BYTE            sccs1 []        = "SysGem V2.50";
...

{
  ...
  i = SearchProgram ( "GEMINI" );
  if ( i == -1 )
    {
      i = SearchProgram ( "THING" );
      if ( i == -1 )
        {
          i = SearchProgram ( "EASE" );
          if ( i == -1 )
            {
              i = SearchProgram ( "JINNEE" );
            }
        }
    }
  return ( i );
...
/* ------------------------------------------------------------------- */
/* Ermittelt Farben fr 3D- Darstellung																 */

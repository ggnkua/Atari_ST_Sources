...
#define WM_ONTOP        31
#define WM_BOTTOMED     33                            /* AES 4.1     [GS] */
#define AC_OPEN         40
#define AC_CLOSE        41
#define CT_UPDATE       50
#define CT_MOVE         51
...
typedef struct /* Special type for EventMulti */
{
        ...
        /* output parameters */
        int     ev_mwich, ev_mmox, ev_mmoy, ev_mmobutton,
                ev_mmokstate,
...
typedef struct
{
        ...
        int             ob_w;       /* object width                 */
        int             ob_h;      /* object height                */
} OBJECT;
...
#define BACKDROP	0x2000																/* [GS] */
#define SMALLER 	0x4000
#define ICONIFIER 0x4000 /* for compatibility */				/* [GS] */

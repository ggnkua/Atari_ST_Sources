...

{
  ...
  if ( win->first == NULL )
    {
      return ( xLinkList ( win_id, text, user ));
    }
...

{
  ...
  if ( line > win->lines )
    {
      return ( xAddToList ( win_id, text, user ));
    }
...
{
  return ( xLinkList ( win_id, text, NULL ));
}
...
{
  return ( xAddToList ( win_id, text, NULL ));
}
...
{
  return ( xInsInList ( win_id, line, text, NULL ));
}

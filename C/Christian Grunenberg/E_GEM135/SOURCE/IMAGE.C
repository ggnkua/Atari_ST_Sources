...
IMAGES cycles = { 2, cycle_im };
IMAGES arrows_up	= { 3, arrow_up_im };
IMAGES arrows_down	= { 3, arrow_dn_im };
IMAGES arrows_right	= { 3, arrow_right_im };
IMAGES arrows_left	= { 3, arrow_left_im };

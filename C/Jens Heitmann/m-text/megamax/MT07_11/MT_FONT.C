...
/* | Teststring ausgeben | */
/* ----------------------- */
show_testtext(xpos, ypos, font_nr, font_hg)
int xpos, ypos, font_nr, font_hg;
{
int dummy, height;
...
/* | Font laden | */
/* -------------- */
load_font_in(font_path, font_nr)
char *font_path;
int font_nr;
{
register int f_handle;
...
inst_font()
{
_GemParBlk.contrl[0]	 = 119;
_GemParBlk.contrl[1]  = 0;
_GemParBlk.contrl[2]  = 0;
_GemParBlk.contrl[3]  = 1;
_GemParBlk.contrl[4]  = 1;
_GemParBlk.contrl[6]  = vdi_handle;
_GemParBlk.contrl[7]	 = scrtchp >> 16;
_GemParBlk.contrl[8]	 = scrtchp;
_GemParBlk.contrl[9]	 = 0xCC << 1;
_GemParBlk.contrl[10] = (long)fnt_point[akt_id] >> 16;
_GemParBlk.contrl[11] = (int)fnt_point[akt_id];
_GemParBlk.intin[0] 	 = 1;

...
MAKEFILENAME = jdkdemo.mak

GFLAGS = -I. -I..\inc -O -DHAL_TIPPER=0 -DDEMO_VERSION=1 #-DUSER_NUMBER=$(USER_NUMBER)
...
all : pro_demo.tos #renamer.prg set_edit.prg cfg_edit.prg rec_excl.prg


player.tos : $(PLYFILES) protect.o protect1.o $(MAKEFILENAME)
	$(G++) protect.o $(PLYFILES) protect1.o -ljk -o player.tos

pro_demo.tos : $(PLYFILES) nprot.o nprot1.o $(MAKEFILENAME)
	$(G++) $(PLYFILES) nprot.o nprot1.o -ljk -o pro_demo.tos

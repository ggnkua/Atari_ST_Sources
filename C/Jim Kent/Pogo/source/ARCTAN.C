...
/* arctan.c - actually find an angle given an x,y vector.  The angle's
   value will be 0 to 1024.  (1024 = two pi, full circle).  */
...
int x,y;
{
return (rscale_by(small_arctan( (long)y, (long)x),360,512));
}

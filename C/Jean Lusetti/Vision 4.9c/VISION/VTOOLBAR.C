...
static void draw_zoombox(int xclip, int yclip, int wclip, int hclip)
{
  objc_draw( adr_icones, ZOOM_BOX, 5, xclip, yclip, wclip, hclip ) ;
}

static void OnDrawVToolBar(void* wd, int xywh[4])
{
...
void VToolBarShow(int show)
{
  ...
  GWSetWindowCaption( WndToolBar, vMsgTxtGetMsg(MSG_TITREOUTIL)  ) ;
}

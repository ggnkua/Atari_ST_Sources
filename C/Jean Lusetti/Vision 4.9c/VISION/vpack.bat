...
xcopy /Y /E SCRIPTS\* X:\documents\MonWeb\vision.doc\scripts
xcopy /Y /E SCRIPTS\* X:\documents\MonWeb\vision.doc\english\scripts
...
echo copy to Hatari...
xcopy /Y /E vision c:\app\Hatari\drivec\temp\vision\
xcopy /Y /E vision c:\app\Hatari\drivecst\temp\vision\
rem xcopy /Y /E vision c:\app\AranymMulti\DriveZ\vision

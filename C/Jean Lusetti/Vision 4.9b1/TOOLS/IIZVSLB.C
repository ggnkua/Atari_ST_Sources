...
#pragma warn -par
static long iizv_slb_plugin_init(IMG_MODULE* img_module)
{
...
static long iizv_slb_reader_init(IMG_MODULE* img_module, const char* name, ZVIMGINFO* info)
{
  long status ;
...
static long iizv_slb_reader_read(IMG_MODULE* img_module, ZVIMGINFO* info, unsigned char* buffer)
{
  long status ;
...
static long iizv_slb_encoder_init(IMG_MODULE* img_module, const char* name, ZVIMGINFO* info)
{
  long status ;
...
static long iizv_slb_encoder_write(IMG_MODULE* img_module, ZVIMGINFO* info, unsigned char* buffer)
{
  long status ;

...
static int StdProgRange(void* w, long current, long max)
{
  ...
  if ( abs_max ) pc = (short) ((100L*current)/abs_max) ;
  if ( pc == 0 ) pc = 1 ; /* To not divide by zero later on */

...
int OnVImgClose(GEM_WINDOW *gwnd)
{
  ...
  if ( vimage->inf_img.mfdb.fd_addr )  Xfree( vimage->inf_img.mfdb.fd_addr ) ;
...
int traite_thickness(int key)
{
  ...
  switch( key )
  {
    case THICKNESS1:   changed = mtype.height = ltype.width = pencil.height = 1 ;
                       break ;

    case THICKNESS2:  changed =  mtype.height = ltype.width = pencil.height = 2 ;
                       break ;

    case THICKNESS3:   changed = mtype.height = ltype.width = pencil.height = 4 ;
                       break ;

   case THICKNESS4:    changed = mtype.height = ltype.width = pencil.height = 8 ;
                       break ;

    case THICKNESS5:  changed =  mtype.height = ltype.width = pencil.height = 12 ;
                       break ;

    case THICKNESS6:   changed = mtype.height = ltype.width = pencil.height = 16 ;
                       break ;

    case THICKNESS7:  changed =  mtype.height = ltype.width = pencil.height = 24 ;
                       break ;

    case THICKNESS8:   changed = mtype.height = ltype.width = pencil.height = 32 ;
                       break ;

    case THICKNESS9:   changed = mtype.height = ltype.width = pencil.height = 48 ;
                       break ;
  }

...
int OnTxtBubbleVToolBar(void *wnd, int mx, int my, char *txt)
{
  ...
  switch( obj )
  {
    case POINT       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HPOINT) ) ;
                       break ;
    case TRACE       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HTRACE) ) ;
                       break ;
    case PINCEAU     : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HPINCEAU) ) ;
                       break ;
    case AEROSOL     : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HAEROSOL) ) ;
                       break ;
    case KLIGNE      : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HKLIGNES) ) ;
                       break ;
    case LIGNE       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HLIGNE) ) ;
                       break ;
    case CERCLE      : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HCERCLE) ) ;
                       break ;
    case RECTANGLE   : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HRECTANGLE) ) ;
                       break ;
    case DISQUE      : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HDISQUE) ) ;
                       break ;
    case PLAN        : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HPLAN) ) ;
                       break ;
    case PEINTURE    : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HPEINTURE) ) ;
                       break ;
    case GOMME       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HGOMME) ) ;
                       break ;
    case TEXTE       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HTEXTE) ) ;
                       break ;
    case LOUPE       : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HLOUPE) ) ;
                       break ;
    case TEMPERATURE : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HTEMP) ) ;
                       break ;
    case TABLEAU     : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HTABLEAU) ) ;
                       break ;
    case MAIN        : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HMAIN) ) ;
                       break ;
    case BLOC        : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HBLOC) ) ;
                       break ;
    case PALETTE     : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HPALETTE) ) ;
                       break ;
    case ZOOM_IN     :
    case ZOOM_VUE    :
    case ZOOM_BOX    : strcpy(txt, MsgTxtGetMsg(hMsg, MSG_HZONE) ) ;
                       break ;
    default          : trouve = 0 ;
  }

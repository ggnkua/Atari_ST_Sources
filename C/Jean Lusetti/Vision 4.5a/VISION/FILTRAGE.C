  ...
  else
  {
    switch(ret)
    {
      case CONVOL_MEMORY        : form_error(8) ;
                                  ...
                                  break ;
      case CONVOL_BADFILTERFILE : form_stop(1, MsgTxtGetMsg(hMsg, MSG_BADFILTER) ) ;
                                  break ;
      case CONVOL_BADNBCOLORS   : form_stop(1, MsgTxtGetMsg(hMsg, MSG_FNBCOLORS) ) ;
                                  break ;
      case CONVOL_BADDSPFILE    : form_stop(1, MsgTxtGetMsg(hMsg, MSG_BADLOD) ) ;
                                  break ;
      case CONVOL_DSPBUSY       : form_stop(1, MsgTxtGetMsg(hMsg, MSG_DSPISLOCKED) ) ;
                                  break ;
      case CONVOL_LODNOTEXIST   : form_stop(1, MsgTxtGetMsg(hMsg, MSG_DSPNOLOD) ) ;
                                  break ;
    }
  }
  mouse_restore() ;

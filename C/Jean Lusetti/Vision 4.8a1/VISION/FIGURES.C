...
void traite_cercle(GEM_WINDOW* gwnd, int fill)
{
  ...
  tod.posx = (int) (0.5+(double)tod.posx/1000.0*(double)(tod.vimage->inf_img.mfdb.fd_w-tod.wx)) ;
  tod.posy = (int) (0.5+(double)tod.posy/1000.0*(double)(tod.vimage->inf_img.mfdb.fd_h-tod.wy)) ;
  ...
  new = (int) (0.5+1000.0*(double)tod.posx/(double)(tod.vimage->inf_img.mfdb.fd_w-tod.wx)) ;
  GWSetHSlider( gwnd, new ) ;
  new = (int) (0.5+1000.0*(double)tod.posy/(double)(tod.vimage->inf_img.mfdb.fd_h-tod.wy)) ;
...
void traite_rectangle(GEM_WINDOW* gwnd, int fill)
{
  ...
  if ( fill )
    undo_put( gwnd, tod.posx+xmin-tod.xi, tod.posy+ymin-tod.yi, tod.posx+xmax-tod.xi, tod.posy+ymax-tod.yi, UPLAN, NULL ) ;
   else
    undo_put( gwnd, tod.posx+xmin-tod.xi, tod.posy+ymin-tod.yi, tod.posx+xmax-tod.xi, tod.posy+ymax-tod.yi, URECT, NULL ) ;
...
void traite_pinceau(GEM_WINDOW* gwnd)
{
  ...
  do
  {
    ...
    if ( (xm >= xi-16) && (ym >= yi-16) && (xm < xi+wx-1) && (ym < yi+wy-1) )
    {
      ...
      switch(pencil.type)
      {
        case 0 : xy[0] = xc-(pencil.height>>1) ;
                 xy[1] = yc-(pencil.height>>1) ;
                 xy[2] = xc+(pencil.height>>1) ;
                 xy[3] = yc+(pencil.height>>1) ;
                 vr_recfl(handle, xy) ;
                 break ;
        case 1 : v_circle(handle, xc, yc, (pencil.height>>1)) ;
                 break ;
        case 2 : xy[0] = xc ;
                 xy[1] = yc-(pencil.height>>1) ;
                 xy[2] = xc+(pencil.height>>1) ;
                 xy[3] = yc ;
                 xy[4] = xc ;
                 xy[5] = yc+(pencil.height>>1) ;
                 xy[6] = xc-(pencil.height>>1) ;
                 xy[7] = yc ;

...
main()
{
	...
	while(!(0x0002&gr_mkmstate))	{
		...
		while (((tmpx1 != gr_mkmx) || (tmpy1 != gr_mkmy)) &&
				((abs(tmpx1, tmpx2) < 4) || (abs(tmpy1, tmpy2) < 4)) &&
				(0x0001&gr_mkmstate))	{
			graf_mkstate(&gr_mkmx, &gr_mkmy, &gr_mkmstate, &gr_mkkstate);
			tmpx1 = gr_mkmx;
			tmpy1 = gr_mkmy;
		...
		if (draw)	{
			...
			*/
			...
			drawicon(tmpx,tmpy);
			graf_mouse(M_ON, 0x0L);
			drawicon(tmpx+65,tmpy);
			drawicon(tmpx+65,tmpy+65);
			drawicon(tmpx+130,tmpy);
			drawicon(tmpx+130,tmpy+130);
			drawicon(tmpx+195,tmpy);
			drawicon(tmpx+195,tmpy+195);
			drawicon(tmpx+260,tmpy);
			drawicon(tmpx+260,tmpy+260);
			drawicon(tmpx+325,tmpy);
			drawicon(tmpx+325,tmpy+325);
			drawicon(tmpx+390,tmpy);
			drawicon(tmpx,tmpy+65);
			drawicon(tmpx+130,tmpy+65);
			drawicon(tmpx+195,tmpy+65);
			drawicon(tmpx+260,tmpy+65);
			drawicon(tmpx+325,tmpy+65);
			drawicon(tmpx+390,tmpy+65);
			drawicon(tmpx,tmpy+130);
			drawicon(tmpx+65,tmpy+130);
			drawicon(tmpx+195,tmpy+130);
			drawicon(tmpx+260,tmpy+130);
			drawicon(tmpx+325,tmpy+130);
			drawicon(tmpx+390,tmpy+130);
			drawicon(tmpx,tmpy+195);
			drawicon(tmpx+65,tmpy+195);
			drawicon(tmpx+130,tmpy+195);
			drawicon(tmpx+260,tmpy+195);
			drawicon(tmpx+325,tmpy+195);
			drawicon(tmpx+390,tmpy+195);
			drawicon(tmpx,tmpy+260);
			drawicon(tmpx+65,tmpy+260);
			drawicon(tmpx+130,tmpy+260);
			drawicon(tmpx+195,tmpy+260);
			drawicon(tmpx+325,tmpy+260);
			drawicon(tmpx+390,tmpy+260);
			drawicon(tmpx,tmpy+325);
			drawicon(tmpx+65,tmpy+325);
			drawicon(tmpx+130,tmpy+325);
			drawicon(tmpx+195,tmpy+325);
			drawicon(tmpx+260,tmpy+325);
			drawicon(tmpx+390,tmpy+325);
			tmpx = gr_mkmx;
			tmpy = gr_mkmy;

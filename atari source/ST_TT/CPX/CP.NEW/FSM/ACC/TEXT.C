...
char alert23[] = "[3][ | The width tables are no | longer valid. Please | update your width tables | at a later time. ][ OK ]";
...
/* FILE: MAINSTUF.C */
char menu_title[] = "  FSM Font Manager";
char alert24[] = "[1][The GEM Desktop has no more|windows.  Please close a|window that you are not|using.][ OK ]";

/* FILE: WINDOWS.C */
char window_title[] = " FSM Font Manager ";

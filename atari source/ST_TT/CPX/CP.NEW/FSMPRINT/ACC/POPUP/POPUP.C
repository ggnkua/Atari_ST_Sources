 ...
 *==========================================================================
 */
short  Pop_Up( char *items[], int num_items, int default_item,
...
int    PopBlit( long *PopPtr, GRECT *clip, int flag );
GRECT  Pop_Offset( GRECT *button, GRECT *world );
void   PopArrow( int obj, int *offset, int num_items, char *item[] );
        ...
        int font_size, GRECT *button, GRECT *world )
{
   ...
   do
   {
       ...
       {
	  event = FALSE;					
          PopArrow( obj, &offset, num_items, items );	
	  Evnt_timer( DELAY );				
       }
 ...
 */
int
PopBlit( long *PopPtr, GRECT *clip, int flag )
{
 ...
 */
void
PopArrow( int obj, int *offset, int num_items, char *items[] )
{
   OBJECT *tree;
   int draw = FALSE;
   int i;

...
/*					do_menu( msg, &event );*/
				...
				case WM_MOVED:
				case WM_NEWTOP:
					form_alert(1,"[3][WM_MESSAGE][OK]");				
					do_windows( msg, &event );
				break;

				case AC_OPEN:
					form_alert(1,"[3][AC_OPEN][OK]");
					acc_open( msg );
				break;

				case AC_CLOSE:
					form_alert(1,"[3][AC_CLOSE][OK]");
					acc_close( msg );
				break;

				default:
					form_alert(1,"[3][DEFAULT][OK]");
					msg_hook( msg, &event );
			} /* switch */
		/* MU_MESAG */

...
MLOCAL	WORD	whandle;
MLOCAL int	f_cancel;	/* some one want to cancel	*/
...
/* 	Set the right drive and call the recursive 
 *	routine to do the counting
*/
...
VOID
chkbuf(int len, int bufsiz, char **src)
{
	char *ptr;
...
VOID
getlastpath(register char *buf, register char *src)
{
	register	char *tmp;

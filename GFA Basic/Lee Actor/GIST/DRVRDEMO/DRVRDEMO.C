...
/*  #define LATTICE for LATTICE compiler */


#ifdef                  LATTICE
#define                 WORD    short

/*  otherwise set-up for MEGAMAX or ALCYON  */
...
#include        <osbind.h>
extern          snd_on(),snd_off(),stop_snd(),get_prior();
...
*/
        ...
        Cconws("\n\n\r This sound is a sound effect...");
        Cconws("Press RETURN to continue ->");
        
        snd_on(drnoise,-1,15,-1,5);
        
        Bconin(2);
        
        Cconws("\n\n\r This sound is another sound effect...");
        Cconws("Press RETURN to continue ->");
...
*/
        ...
        Cconws("\r Press RETURN to issue a snd_off ->");
...
*/
        Cconws("\n\n\r This sound will continue indefinitely...\n");
        Cconws("\r Press RETURN to interrupt this sound");
        Cconws("\n\r  and play DRWHO with a higher priority ->");
...
*/
        ...
        Cconws("\n\r This sound will continue indefinitely...");
        Cconws("\n\r Press RETURN to issue a stop_snd and exit ->");

- download polarssl/mbedtls 1.3.22 library from https://polarssl.org
...
- add "#include <string.h>" at start of file \library\camelia.c if you have memset and memcpy lack of declaration error

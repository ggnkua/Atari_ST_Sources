...
IF numbers < 2 OR numbers > 10 THEN
    PRINT "You are only allowed from 2 to 10 numbers !  Please try again!"
    GOTO money
END IF
cost = sets * numbers * 1
...
NEXT i
PRINT
PRINT "Number Chart From 1 to 6"
PRINT
FOR iii = 1 TO 5
    PRINT USING "  Num ## : ####   Num ## : ####   Num ## :  ####"; iii; outpt(iii); iii + 2; outpt(iii + 2); iii + 3; outpt(iii + 3);
    PRINT USING "  Num ## : ####   Num ## : ####   Num ## :  ####"; iii + 4; outpt(iii + 4); iii + 5; outpt(iii + 5); iii + 6; outpt(iii + 6);
    PRINT USING "  Num ## : ####   Num ## : ####   Num ## :  ####"; iii + 7; outpt(iii + 7); iii + 8; outpt(iii + 8); iii + 9; outpt(iii + 9);
    PRINT USING "  Num ## : ####   Num ## : ####   Num ## :  ####"; iii + 10; outpt(iii + 10); iii + 11; outpt(iii + 11); iii + 12; outpt(iii + 12)
NEXT iii
FOR i = 1 TO 10
...
IF numbrs > 10 THEN
    PRINT "10 Is The Limit of numbers that you can buy."
END IF
FOR zqa = 1 TO numbrs
    rd2:
    IF saved$ = "Y" THEN
...
ELSEIF answer$ = "YES" THEN
    OPEN "kenomidday.dat" FOR OUTPUT AS #1
    CLOSE #1
END IF
GOTO main
buildchart:
...
linecounter = 0
ERASE chart
OPEN "kenomidday.dat" FOR INPUT AS #1
DO UNTIL EOF(1)

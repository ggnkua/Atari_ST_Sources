...
$(TARGET): $(OBJS)
	$(CC) ./build/68000/$(OBJS) $(CFLAGS) -m68000 $(LDLIBS) -o ./build/68000/$(TARGET)
	$(CC) ./build/68020/$(OBJS) $(CFLAGS) -m68020-60 $(LDLIBS) -o ./build/68020/$(TARGET)
	$(CC) ./build/ColdFire/$(OBJS) $(CFLAGS) -mcpu=5475 $(LDLIBS) -o ./build/ColdFire/$(TARGET)

...
#include "encdec/atarist.h"

#include "encdec/viscii.h"

#include "encdec/utf16.h"
#include "encdec/utf16be.h"
#include "encdec/utf16le.h"
...
const struct tiniconv_charset_map_entry_s tiniconv_charset_map[] =
{
  ...
  {atarist_mbtowc,			NULL,           atarist_wctomb,			 NULL            }, /* 39 */
  {viscii_mbtowc,				NULL,           viscii_wctomb,			 NULL            }, /* 40 */
  {utf16_mbtowc,			  NULL,           utf16_wctomb,			   NULL            }, /* 41 */
  {utf16be_mbtowc,			NULL,           utf16be_wctomb,			 NULL            }, /* 42 */
  {utf16le_mbtowc,			NULL,           utf16le_wctomb,			 NULL            }, /* 43 */
  {NULL,                NULL,           NULL,                NULL            }
};

...
The version is self-installing and use German language.

-------------------------------------------------------

german\sysdir\GfaWin20.exe

  This Setup package defaults to the system directory
  and cannot install the GfaWin20.Ocx to another place.
  ...
  For the same reason, sysdir\GfaWin20.exe will not run
...
COMMAND LINE PARAMETERS
  ...
  sysdir\GfaWin20.exe understands this command line parameter:
